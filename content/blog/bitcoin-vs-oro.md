---
title: "Bitcoin gana al oro como reserva de valor (Bitcoin VS oro)"
...
[https://www.ivoox.com/bitcoin-gana-al-oro-como-reserva-valor_md_78782196_wp_1.mp3](https://www.ivoox.com/bitcoin-gana-al-oro-como-reserva-valor_md_78782196_wp_1.mp3)
...
![oro vs bitcoin](https://pau.ninja/wp-content/uploads/2021/11/oro-vs-bitcoin.jpeg)

La pregunta del millón es: ¿estamos en lo correcto? ¿o es sólo una moda pasajera? ¿realmente **Bitcoin es una mejor opción** como [valor refugio (reserva de valor)](https://pau.ninja/valores-refugio/) que no el oro?
...
- [Definiendo el valor refugio](#Definiendo_el_valor_refugio 'Definiendo el valor refugio')
- [Propiedades del dinero duro](#Propiedades_del_dinero_duro 'Propiedades del dinero duro')
  - [Dinero digital VS dinero analógico](#Dinero_digital_VS_dinero_analogico 'Dinero digital VS dinero analógico')
  - [Cambio de narrativa](#Cambio_de_narrativa 'Cambio de narrativa')
  - [Protección contra la inflación](#Proteccion_contra_la_inflacion 'Protección contra la inflación')
  - [Asteroides con oro](#Asteroides_con_oro 'Asteroides con oro')
  - [El oro como dinero](#El_oro_como_dinero 'El oro como dinero')
- [Bitcoin VS oro](#Bitcoin_VS_oro 'Bitcoin VS oro')
  - [Privacidad y transparencia](#Privacidad_y_transparencia 'Privacidad y transparencia')
  - [Confianza](#Confianza 'Confianza')
  - [Bajas comisiones](#Bajas_comisiones 'Bajas comisiones')
  - [Histórico](#Historico 'Histórico')
- [El ganador](#El_ganador 'El ganador')

## Definiendo el valor refugio

Lo llamamos «valor refugio» o «reserva de valor» porque nos **protege**. ¿De qué? pues de las hostias [del funcionamiento del sistema monetario actual](https://pau.ninja/sistema-monetario-actual/) (#126).
...
Una reserva de valor de verdad nos tiene que [proteger de la devaluación del dinero](https://pau.ninja/devaluacion-de-la-moneda/) falso con el que estamos jugando a una partida (muy larga) de Monopoly.

Lo sé. Es un *shock* para muchos. No sólo es que suban los precios, es que el valor de la divisa que usamos (euros, dólares), también baja.

## Propiedades del dinero duro

La única manera de protegernos es convirtiendo nuestros ahorros de divisa fiduciara, a dinero duro. [Las propiedades del dinero son muy claras](https://pau.ninja/propiedades-del-dinero/) (#119). Si las comparamos con FIAT (dinero fiduciario) vemos que este no cumple con las características, así que ¿cómo **no** nos va a perder valor?
...
![meme oro ahorros](https://pau.ninja/wp-content/uploads/2021/11/meme-oro-ahorros.jpg)
...
Han decidido que por protección, en vez de comprar oro querían comprar Bitcoin… y esto han hecho.
...
Esperad a que se privatice la exploración espacial y Musk & Bezos y compañía se hagan con la de piedras chapadas en oro flotando por el espacio que quieran.
...
[Cuando se originó el Bitcoin](https://pau.ninja/historia-y-origen-del-bitcoin/), se creó con la idea precisamente de ser dinero duro, de ser una reserva de valor. Como es un producto de la ingeniería humana, se pudieron **perfeccionar todas las propiedades del oro como valor refugio**.
...
Y sé que esta última frase ya empieza a sonar un poco más técnica, pero sin usar la jerga tecnológica se puede [explicar qué es el Bitcoin para tontos](https://pau.ninja/que-es-bitcoin-para-tontos/) (#158).
...
He sido poco sutil, ¿no? claro que creo que **Bitcoin gana el combate contra el oro** en cuanto a la reserva de valor. A refugiarnos del sistema monetario actual. O al menos… a día de hoy.
