---
title: "Periodización: el arte de seguir progresando en el gimnasio (qué es en el entrenamiento y cómo organizarte)"
...
Algo que va en contra de la ciencia del [entrenamiento para ganar músculo](https://pau.ninja/entrenamiento-ganar-masa-muscular/). La evidencia dice que volumen de entreno = volumen muscular (hipertrofia), pero según mis registros… había estado haciendo **mucha menos cantidad de ejercicios y series**.
...
Es lo que se conoce como [sobrecarga progresiva](https://pau.ninja/sobrecarga-progresiva-gym/) (#352) que conocimos gracias al mito de Milón de Crotona. Según la leyenda cada día cogía un ternerito pequeño y lo transportaba de una granja a otra.
...
- [Qué es la periodización](#Que_es_la_periodizacion 'Qué es la periodización')
- [Frecuencia de entrenamiento](#Frecuencia_de_entrenamiento 'Frecuencia de entrenamiento')
- [Volumen de entrenamiento](#Volumen_de_entrenamiento 'Volumen de entrenamiento')
- [Intensidad de entrenamiento](#Intensidad_de_entrenamiento 'Intensidad de entrenamiento')
- [Cómo periodizar entrenamiento de fuerza](#Como_periodizar_entrenamiento_de_fuerza 'Cómo periodizar entrenamiento de fuerza')
- [Ejemplos de periodización del entrenamiento](#Ejemplos_de_periodizacion_del_entrenamiento 'Ejemplos de periodización del entrenamiento')
  - [Volumen alto, frecuencia alta, intensidad baja](#Volumen_alto_frecuencia_alta_intensidad_baja 'Volumen alto, frecuencia alta, intensidad baja')
  - [Frecuencia alta, intensidad alta, volumen bajo](#Frecuencia_alta_intensidad_alta_volumen_bajo 'Frecuencia alta, intensidad alta, volumen bajo')
  - [Intensidad alta, volumen alto, frecuencia baja](#Intensidad_alta_volumen_alto_frecuencia_baja 'Intensidad alta, volumen alto, frecuencia baja')
  - [Mucha frecuencia, volumen bajo, intensidad baja](#Mucha_frecuencia_volumen_bajo_intensidad_baja 'Mucha frecuencia, volumen bajo, intensidad baja')
  - [Mucho volumen, frecuencia baja, intensidad baja](#Mucho_volumen_frecuencia_baja_intensidad_baja 'Mucho volumen, frecuencia baja, intensidad baja')
  - [Mucha intensidad, frecuencia baja, volumen bajo](#Mucha_intensidad_frecuencia_baja_volumen_bajo 'Mucha intensidad, frecuencia baja, volumen bajo')
- [La clave de la periodización es...](#La_clave_de_la_periodizacion_es 'La clave de la periodización es...')
...
Los naturales usamos la sesión de entrenamiento para [activar la síntesis proteica muscular](https://pau.ninja/sintesis-proteica-muscular/). Lo que construye masa. Esto significa que como más veces entrene un músculo, más ganancias muscular tendré[2](<javascript:void(0)>)Differences between natural training vs enhanced training Coach Christian Thibaudeau – Thibarmy.
...
![volumen alto](https://pau.ninja/wp-content/uploads/2022/10/volumen-alto.png)
...
![intensidad alta](https://pau.ninja/wp-content/uploads/2022/10/intensidad-alta.png)
...
![mucha frecuencia](https://pau.ninja/wp-content/uploads/2022/10/mucha-frecuencia.png)
...
![mucha intensidad](https://pau.ninja/wp-content/uploads/2022/10/mucha-intensidad.png)
