---
title: "Flexiones en pica Niveles, pasos y progresiones para flexiones pike"
...
- 🔎 **Biomecánica:** [empuje vertical](https://pau.ninja/ejercicios-empuje-vertical/) + [empuje horizontal](https://pau.ninja/ejercicios-empuje-horizontal/) (híbrido)
...
- [Qué son las flexiones en pica](#Que_son_las_flexiones_en_pica 'Qué son las flexiones en pica')
  - [Los músculos de pike push up](#Los_musculos_de_pike_push_up 'Los músculos de pike push up')
  - [Pasos para hacer flexiones en pica](#Pasos_para_hacer_flexiones_en_pica 'Pasos para hacer flexiones en pica')
- [Progresiones por niveles de dificultad](#Progresiones_por_niveles_de_dificultad 'Progresiones por niveles de dificultad')
  - [Nivel #1. Pica inclinada](#Nivel_1_Pica_inclinada 'Nivel #1. Pica inclinada')
  - [Nivel #2. Encogimientos de pica](#Nivel_2_Encogimientos_de_pica 'Nivel #2. Encogimientos de pica')
  - [Nivel #3. Flexiones negativas](#Nivel_3_Flexiones_negativas 'Nivel #3. Flexiones negativas')
  - [Nivel #4. Flexiones de pica en el suelo](#Nivel_4_Flexiones_de_pica_en_el_suelo 'Nivel #4. Flexiones de pica en el suelo')
  - [Nivel #5. Flexiones de pica avanzadas](#Nivel_5_Flexiones_de_pica_avanzadas 'Nivel #5. Flexiones de pica avanzadas')
- [Errores más comunes](#Errores_mas_comunes 'Errores más comunes')
  - [No hacer suficiente "pica"](#No_hacer_suficiente_%22pica%22 'No hacer suficiente "pica"')
  - [Codos a 90 grados](#Codos_a_90_grados 'Codos a 90 grados')
  - [Ángulo de la cabeza](#Angulo_de_la_cabeza 'Ángulo de la cabeza')
  - [Rango de movimiento](#Rango_de_movimiento 'Rango de movimiento')
- [Consejos al practicar flexiones pike](#Consejos_al_practicar_flexiones_pike 'Consejos al practicar flexiones pike')
  - [Elegir el objetivo](#Elegir_el_objetivo 'Elegir el objetivo')
  - [Posicionarse en diagonal](#Posicionarse_en_diagonal 'Posicionarse en diagonal')
  - [Entrenar con propósito](#Entrenar_con_proposito 'Entrenar con propósito')
...
De hecho, del [repertorio de ejercicios de hombro para calistenia](https://pau.ninja/ejercicios-hombros-calistenia/), sitúo las flexiones de pica en el podio de los mejores para desarrollar los deltoides en fuerza e hipertrofia.
...
![pica inclinada](https://pau.ninja/wp-content/uploads/2022/05/pica-inclinada.jpeg)
...
![pica elevada en caja](https://pau.ninja/wp-content/uploads/2022/05/pica-elevada-en-caja.jpeg)
...
Si no quieres obviar el ejercicio pero no puedes ponerte en pica, una opción es hacerte con unos [soportes para flexiones](https://pau.ninja/material-calistenia/#Soporte_para_flexiones). Así con las manos elevadas así **decrecemos como de lejos necesitamos «caer»** hacia adelante.
...
[https://thumbs.gfycat.com/ThisVacantFalcon-mobile.mp4](https://thumbs.gfycat.com/ThisVacantFalcon-mobile.mp4)
...
Queremos tanto el cuello como la espalda tan neutral como sea posible, y si hace falta un poco más de rango siempre puedes comprar unas [paralettes](https://pau.ninja/material-calistenia/#Paralletes) para ir más al fondo (como yo yendo al fondo de este ejercicio).
...
![pike push up ejemplo](https://pau.ninja/wp-content/uploads/2022/05/pike-push-up-ejemplo.jpeg)
