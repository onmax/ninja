---
title: "Argumento de autoridad: o cómo creerte sus mentiras (la falacia Ad verecundiam)"
...
- [Qué es un argumento de autoridad o Ad verecundiam](#Que_es_un_argumento_de_autoridad_o_Ad_verecundiam 'Qué es un argumento de autoridad o Ad verecundiam')
  - [Sesgos cognitivos del argumento](#Sesgos_cognitivos_del_argumento 'Sesgos cognitivos del argumento')
- [Ejemplos de argumentos de autoridad](#Ejemplos_de_argumentos_de_autoridad 'Ejemplos de argumentos de autoridad')
  - [Ciencia](#Ciencia 'Ciencia')
  - [Medio ambiente](#Medio_ambiente 'Medio ambiente')
  - [Aborto](#Aborto 'Aborto')
  - [Maltrato animal](#Maltrato_animal 'Maltrato animal')
  - [Drogas](#Drogas 'Drogas')
  - [Violencia de género](#Violencia_de_genero 'Violencia de género')
  - [Tecnología](#Tecnologia 'Tecnología')
  - [Redes sociales](#Redes_sociales 'Redes sociales')
- [Tipos de argumentos autoridad](#Tipos_de_argumentos_autoridad 'Tipos de argumentos autoridad')
  - [Apelación a la autoridad anónima](#Apelacion_a_la_autoridad_anonima 'Apelación a la autoridad anónima')
  - [Apelación a la falsa autoridad](#Apelacion_a_la_falsa_autoridad 'Apelación a la falsa autoridad')
  - [Apelaciones legítimas a la autoridad](#Apelaciones_legitimas_a_la_autoridad 'Apelaciones legítimas a la autoridad')
- [Cómo no caer en los argumentos de autoridad](#Como_no_caer_en_los_argumentos_de_autoridad 'Cómo no caer en los argumentos de autoridad')
  - [Pregúntate las razones para dar información](#Preguntate_las_razones_para_dar_informacion 'Pregúntate las razones para dar información')
  - [Busca otras fuentes para respaldar o contrastar](#Busca_otras_fuentes_para_respaldar_o_contrastar 'Busca otras fuentes para respaldar o contrastar')
  - [Leer las fuentes de forma crítica](#Leer_las_fuentes_de_forma_critica 'Leer las fuentes de forma crítica')
- [¿Deberías creer mis argumentos?](#%C2%BFDeberias_creer_mis_argumentos '¿Deberías creer mis argumentos?')

## Qué es un argumento de autoridad o _Ad verecundiam_
...
- Los científicos dicen que el 5G, el bluetooth y que [los efectos de las radiaciones electromagnéticas](https://pau.ninja/efectos-ondas-electromagneticas/) son totalmente inofensivas
...
Si un asesor financiero titulado te recomienda en una consultoría [que inviertas en fondos indexado](https://pau.ninja/fondos/), quizás estás haciendo una apelación legítima en la autoridad.
