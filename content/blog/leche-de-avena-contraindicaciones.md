---
title: "Leche de avena: el veneno más vendido del Apocalipsis (contraindicaciones + 1 mejor alternativa)"
...
![compras leche avena](https://pau.ninja/wp-content/uploads/2022/09/compras-leche-avena.jpeg)
...
¿Pero quien tiene paciencia para eso? Ni nosotros, ni las empresas.
...
- [Beneficios de la leche de avena](#Beneficios_de_la_leche_de_avena 'Beneficios de la leche de avena')
- [Contraindicaciones de la leche de avena](#Contraindicaciones_de_la_leche_de_avena 'Contraindicaciones de la leche de avena')
  - [Perfil incompleto de aminoácidos](#Perfil_incompleto_de_aminoacidos 'Perfil incompleto de aminoácidos')
  - [Antinutrientes naturales](#Antinutrientes_naturales 'Antinutrientes naturales')
  - [Incluye aceites de semilla vegetales](#Incluye_aceites_de_semilla_vegetales 'Incluye aceites de semilla vegetales')
  - [Contenido de fibra insignificante](#Contenido_de_fibra_insignificante 'Contenido de fibra insignificante')
  - [Incorpora muchos agroquímicos](#Incorpora_muchos_agroquimicos 'Incorpora muchos agroquímicos')
  - [Preparación industrializada](#Preparacion_industrializada 'Preparación industrializada')
  - [Los ingredientes contenidos](#Los_ingredientes_contenidos 'Los ingredientes contenidos')
- [Leche de avena fermentada](#Leche_de_avena_fermentada 'Leche de avena fermentada')
- [Leche de avena VS leche de vaca](#Leche_de_avena_VS_leche_de_vaca 'Leche de avena VS leche de vaca')
  - [La mejor leche del mercado](#La_mejor_leche_del_mercado 'La mejor leche del mercado')
  - [Conclusión](#Conclusion 'Conclusión')
...
Lo que ponen en el cartón es los valores **en papel** de un alimento vegetal que les ha salido analizándolo en el laboratorio. Con esto legalmente ya pueden decir este «alimento» a base de plantas tiene X gramos de proteínas.
...
![leucina entre alimentos](https://pau.ninja/wp-content/uploads/2022/09/leucina-entre-alimentos.png)
...
Cuidado con estas combinaciones porque hasta llegan a promoverlos como el compañero nutritivo ideal en dieta [vegana durante el embarazo](https://pau.ninja/dieta-vegana-embarazo/). Me parece una aberración. Por ejemplo:
...
Es por esto que todas estas combinación no sólo nos dan una forma **menos cualitativa** de proteínas, sino que además llevan una [lista de antinutrientes](https://pau.ninja/antinutrientes-lista/). Moléculas que nos «secuestran» las cosas buenas del cuerpo.

- Las espinacas tienen antinutrientes como [oxalatos](https://pau.ninja/antinutrientes-lista/#Oxalatos) que nos roban todo el calcio
- Las lentejas y los garbanzos tienen [lectinas](https://pau.ninja/antinutrientes-lista/#Lectinas), otro antinutriente que en este caso nos «roban» vitaminas y minerales
...
La mayoría de gente dice no tener tanto tiempo así que en vez de dejarla reposar, compran leche directamente, lo cuál puede ser aún peor muchas veces porque la mayoría incluyen aceites de semilla vegetal.
...
![reducir fibra es sano](https://pau.ninja/wp-content/uploads/2022/09/reducir-fibra-es-sano.png)
...
Increíble. ¿Quien lo hubiera dicho?
...
![riesgo suplementar calcio](https://pau.ninja/wp-content/uploads/2022/09/riesgo-suplementar-calcio.png)
...
Las [consecuencias de la falta de vitamina D ya son peores](https://pau.ninja/falta-de-vitamina-d-consecuencias/) en si mismas, porque necesitamos vitamina D + K2 para movilizar y utilizar el calcio. O sea que necesitamos **mucho menos calcio, y más vitamina D** para movilizarlo.

Pero es que nos meten en los ingredientes D2. **No necesitamos vitamina D2**, necesitas [vitamina D3 tomando el sol](https://pau.ninja/como-tomar-sol-absorber-vitamina-d/). Pero bueno. Habrán incluido la D2 porque es vegana y barata.
...
Muchos de estos nutrientes requieren [las buenas de las grasas saturadas](https://pau.ninja/grasas-saturadas-son-buenas/) para que se absorban (#189).

## Leche de avena fermentada

Había grupos de indígenas en Escocia que sustentaron un alto porcentaje de sus calorías con avena. Pero, nada que ver con la avena que comprarás en el supermercado, y aún menos de la mi3rda que encontrarás dentro de tu cartoncito de avena.
...
La leche cruda (no pasteurizada) es la mejor y más sana del mercado pero creo que había sido ilegal en España.
