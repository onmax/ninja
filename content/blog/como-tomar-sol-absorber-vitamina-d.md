---
title: "Olvida el bronceado: toma el sol para absorber vitamina D (cómo hacerlo sin quemarte)"
...
- [Cuál es la vitamina del sol](#Cual_es_la_vitamina_del_sol 'Cuál es la vitamina del sol')
- [Cantidad de sol necesaria para sintetizar vitamina D](#Cantidad_de_sol_necesaria_para_sintetizar_vitamina_D 'Cantidad de sol necesaria para sintetizar vitamina D')
- [Qué parte del cuerpo absorbe mejor la vitamina D](#Que_parte_del_cuerpo_absorbe_mejor_la_vitamina_D 'Qué parte del cuerpo absorbe mejor la vitamina D')
- [Cuanto tiempo tomar sol para vitamina D](#Cuanto_tiempo_tomar_sol_para_vitamina_D 'Cuanto tiempo tomar sol para vitamina D')
- [Pasos a tener en cuenta para obtener vitamina D](#Pasos_a_tener_en_cuenta_para_obtener_vitamina_D 'Pasos a tener en cuenta para obtener vitamina D')
  - [Índice de rayos UV superior a 3](#Indice_de_rayos_UV_superior_a_3 'Índice de rayos UV superior a 3')
  - [Ser más alto que tu sombra](#Ser_mas_alto_que_tu_sombra 'Ser más alto que tu sombra')
  - [Exponerse con superficie piel](#Exponerse_con_superficie_piel 'Exponerse con superficie piel')
  - [Tener en cuenta tu tipo de piel](#Tener_en_cuenta_tu_tipo_de_piel 'Tener en cuenta tu tipo de piel')
  - [Seguir una dieta poco inflamatoria](#Seguir_una_dieta_poco_inflamatoria 'Seguir una dieta poco inflamatoria')
  - [Puedes usar camas de bronceado](#Puedes_usar_camas_de_bronceado 'Puedes usar camas de bronceado')
- [Mitos de tomar el sol para la vitamina D](#Mitos_de_tomar_el_sol_para_la_vitamina_D 'Mitos de tomar el sol para la vitamina D')
...
Lo que pasa es que se necesita tener bastante más piel expuesta que diez minutillos. ¿Cuánto tiempo necesitamos? entran factores como el tipo de piel, el tiempo que tardamos en quemarnos, la latitud, si hay nubes, el horario… y también, la cantidad de piel que tienes expuesta.
...
Vitaminas que sólo están en las grasas animales. Por esto unas [buenas grasas saturadas en la dieta](https://pau.ninja/grasas-saturadas-son-buenas/) son esenciales.
...
![exposición 1000iu vitamina d](https://pau.ninja/wp-content/uploads/2022/06/exposicion-1000iu-vitamina-d.png)
...
Todos os acordáis del [truco que di para ponerse moreno rápido](https://pau.ninja/como-ponerse-moreno-rapidamente/), en el que me echo unas gotas en el torso y me pongo moreno mucho más rápido.
...
Es la manera natural del cuerpo de buscar ese balance de vitaminas y hormonas. Si hay áreas de nuestro cuerpo donde se produce más vitamina D, tiene sentido que es lo que se volverá más moreno y por lo tanto se bloqueará antes la vitamina D3 por esa zona.
...
![índice rayos uv](https://pau.ninja/wp-content/uploads/2022/06/indice-rayos-uv.jpeg)
...
![app vitamina d](https://pau.ninja/wp-content/uploads/2022/06/app-vitamina-d.jpeg)
...
![regla de la sombra](https://pau.ninja/wp-content/uploads/2022/06/regla-de-la-sombra.png)
...
Siempre estoy hablando de [tomar el sol sin crema](https://pau.ninja/tomar-el-sol-sin-crema/), claro.
...
Marrón, castaño medio y castaño oscuro
...
Lo ideal sería la exposición al sol, claro, pero ¿que podemos hacer durante el invierno o cuándo nuestros trabajos nos impiden salir durante el mediodía? pues la segunda mejor opción sería seguramente las camas de bronceado.
...
![chica en cama de bronceado](https://pau.ninja/wp-content/uploads/2022/06/chica-en-cama-de-bronceado.jpeg)
