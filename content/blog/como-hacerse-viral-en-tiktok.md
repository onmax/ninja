---
title: "Viral en TikTok: los secretos de tener 100.000 seguidores (cómo crecer y triunfar con contenido corto)"
...
![100.000 seguidores en tiktok](https://pau.ninja/wp-content/uploads/2023/02/100000-seguidores-tiktok.png)
...
Igual que no ha sido un multimillonario quien ha escrito estos artículos, la mayoría de los que hacen escritos de cómo hacerse viral en TikTok son blogs de poca monda con cuentas de 100 seguidores en estas redes.
...
- [El secreto del algoritmo de TikTok](#El_secreto_del_algoritmo_de_TikTok 'El secreto del algoritmo de TikTok')
  - [Instagram VS TikTok](#Instagram_VS_TikTok 'Instagram VS TikTok')
  - [Cómo triunfar en TikTok](#Como_triunfar_en_TikTok 'Cómo triunfar en TikTok')
  - [Mi primer vídeo viral en TikTok](#Mi_primer_video_viral_en_TikTok 'Mi primer vídeo viral en TikTok')
  - [Vídeos más virales de TikTok](#Videos_mas_virales_de_TikTok 'Vídeos más virales de TikTok')
  - [Cómo funciona el algoritmo de TikTok](#Como_funciona_el_algoritmo_de_TikTok 'Cómo funciona el algoritmo de TikTok')
- [Cómo (no) ganar seguidores en TikTok](#Como_no_ganar_seguidores_en_TikTok 'Cómo (no) ganar seguidores en TikTok')
  - [Usa etiquetas relacionadas con el vídeo](#Usa_etiquetas_relacionadas_con_el_video 'Usa etiquetas relacionadas con el vídeo')
  - [Céntrate en un nicho](#Centrate_en_un_nicho 'Céntrate en un nicho')
  - [Interactúa con usuarios y creadores](#Interactua_con_usuarios_y_creadores 'Interactúa con usuarios y creadores')
- [Cómo hacerse viral en TikTok](#Como_hacerse_viral_en_TikTok 'Cómo hacerse viral en TikTok')
  - [Empieza con seguidores fieles](#Empieza_con_seguidores_fieles 'Empieza con seguidores fieles')
  - [Engancha al usuario en 3 segundos](#Engancha_al_usuario_en_3_segundos 'Engancha al usuario en 3 segundos')
  - [Mantén el vídeo corto](#Manten_el_video_corto 'Mantén el vídeo corto')
  - [Usa subtítulos animados](#Usa_subtitulos_animados 'Usa subtítulos animados')
  - [Ten opiniones controvertidas](#Ten_opiniones_controvertidas 'Ten opiniones controvertidas')
  - [Ancla el comentario más polémico](#Ancla_el_comentario_mas_polemico 'Ancla el comentario más polémico')
  - [Habla de algo que entiendas](#Habla_de_algo_que_entiendas 'Habla de algo que entiendas')
  - [Prepárate psicológicamente](#Preparate_psicologicamente 'Prepárate psicológicamente')
  - [Escribe un guión](#Escribe_un_guion 'Escribe un guión')
  - [Crea vídeo entretenido al completo](#Crea_video_entretenido_al_completo 'Crea vídeo entretenido al completo')
  - [No elimines contenido antiguo](#No_elimines_contenido_antiguo 'No elimines contenido antiguo')
  - [Elegir la mejor hora para publicar](#Elegir_la_mejor_hora_para_publicar 'Elegir la mejor hora para publicar')
- [Ideas para hacerse viral en TikTok](#Ideas_para_hacerse_viral_en_TikTok 'Ideas para hacerse viral en TikTok')
...
Por ejemplo: en [mi TikTok más viral](https://www.tiktok.com/@pau_ninja/video/7182645548590058758) hablando de [por qué los tatuajes son malos para la salud](https://pau.ninja/tatuajes-malos-para-la-salud/), menciono 3 estudios. ¿Importa que los mencione? Para nada en absoluto, los puse para salvaguardarme de muchos comentarios de _hate_ (de los cuáles no me salvé en absoluto). Pero este TikTok de los tatuajes pasó de **6 millones de visualizaciones** porque apeló a las emociones de manera impecable:
...
[Este TikTok](https://www.tiktok.com/@pau_ninja/video/7155166022541085958) llegó a pasar las 600k reproducciones y fue lo que me incentivó a dejar de hacer cortes de podcast, y de hecho desarrollar guiones específicos pensando directamente en la viralidad.
...
Muchos creadores de contenido se centran en los detalles equivocados.
...
El algoritmo está curado de modo que en el momento que abras TikTok ya empiezas a hacer *scroll*. Nadie más que **los propios creadores se van a ver página de etiquetas** específicas a ver qué videos hay allí dentro.
...
Si tienes ganas de perder el tiempo respondiendo comentarios, estás en todo tu derecho, pero esto no ayuda a hacer crecer tu audiencia. Ya se comentarán y contestarán entre ellos en los comentarios de tu video cuando crees un buen contenido que cree la polaridad de la que hablábamos.
...
Empecé mi cuenta de TikTok con 40 seguidores. Tenía miles de *followers* en Instagram y dije «chavales me he abierto una cuenta», y sólo 40 personas me empezaron a seguir. Así de bien me fue… pero en realidad no importa que fueran 10 o que fueran 40 como 400.
...
- Que necesitas implementar más [_storytelling_](https://pau.ninja/storytelling-para-contar-historias/), haciendo que tu historia o mensaje enganche más y quizás desde un punto de vista más personal.
- Que necesitas ajustar la duración de tu TikTok porque quizás te has extendido demasiado.

### Mantén el vídeo corto

Cuando sucede este último punto en el que el gráfico tiene buena pinta pero es justo en el final que cae en picado, ¿qué ha sucedido? Esto es que los usuarios se han cansado de ti… (al igual que tus ex).
...
Si crees no tener la autoridad para representar una controversia, lo que puedes hacer es adjuntar tu opinión a la de una autoridad. Del rollo «¿por qué el _influencer_ de los tatuajes ReneZZ va a morir joven? Pues porque los tatuajes son malos para la salud.» Y haces todo el TikTok referente a esto.

Quizás hasta te responda y aún haya más viralidad asegurada.

### Ancla el comentario más polémico

Cuando empieces a tener comentarios, verás que hay un tipo de comentarios que tienen tirón en si mismos. Es decir, comentarios que los propios usuarios quieren comentar o darle al *like*.
...
![comentario polémico fijado](https://pau.ninja/wp-content/uploads/2023/02/comentario-polemico-fijado.jpeg)
...
Por esto tienes que estar **preparado psicológicamente para tener *haters***. ¿Cómo no vas a tenerlos si tu opinión es controvertida? Llegarás a muchas personas que les interesa un tema pero **esto no significa que estén de acuerdo**. Tienes que estar bien con una de estas dos opciones:
...
Cuando creas contenido polarizante, ya son los usuarios que comparten tu opinión los que debaten y te defienden (porque le están atacando sus opiniones).
...
Ha sido todo un acierto no sólo porque suda completamente de los comentarios de *hate*, sino también porque así no me miro TikTok como consumidor para centrarme en ser creador.
...
![tiktok calvo](https://pau.ninja/wp-content/uploads/2023/02/tiktok-calvo.jpeg)
...
Si que puede tener sentido poner el pin, anclar a los 3 vídeos más relevantes porque para los pocos que miren tu perfil y pasen un rato allí, pueden ver de qué va tu rollo y hasta empujar a que esos videos más vistos tengan aún más viralidad.
...
El tema del video ya es algo más sensible porque TikTok también funciona mucho por *trends*. Por modas.
