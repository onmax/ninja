---
title: "Fallo muscular: el arte de entrenar menos… y ganar más músculo (cómo gane masa muscular y fuerza entrenando poco)"
...
Siempre que he tenido una época de vicio en el gimnasio he estado haciendo demasiado [volumen de entrenamiento](https://pau.ninja/volumen-de-entrenamiento/) (#415), y de hecho **es muy fácil hacer demasiado**. Pero en esa época no sé por qué sólo estaba haciendo una única serie por ejercicio. Ironías de la vida porque en pocas semanas estaba mejor de cuerpo. Otro ejemplo de que más no es mejor.
...
- [Qué es el fallo muscular](#Que_es_el_fallo_muscular 'Qué es el fallo muscular')
  - [¿Qué es entrenar al fallo?](#%C2%BFQue_es_entrenar_al_fallo '¿Qué es entrenar al fallo?')
  - [¿Es necesario llegar al fallo?](#%C2%BFEs_necesario_llegar_al_fallo '¿Es necesario llegar al fallo?')
- [Llegar al fallo muscular es bueno o malo](#Llegar_al_fallo_muscular_es_bueno_o_malo 'Llegar al fallo muscular es bueno o malo')
- [Fallo muscular para hipertrofia](#Fallo_muscular_para_hipertrofia 'Fallo muscular para hipertrofia')
- [Cuando llegar al fallo muscular](#Cuando_llegar_al_fallo_muscular 'Cuando llegar al fallo muscular')
- [Beneficios de llegar al fallo muscular](#Beneficios_de_llegar_al_fallo_muscular 'Beneficios de llegar al fallo muscular')
  - [Menos frecuencia de entrenamiento](#Menos_frecuencia_de_entrenamiento 'Menos frecuencia de entrenamiento')
  - [Menos volumen de entrenamiento](#Menos_volumen_de_entrenamiento 'Menos volumen de entrenamiento')
  - [Más intensidad del entrenamiento](#Mas_intensidad_del_entrenamiento 'Más intensidad del entrenamiento')
- [Cómo llegar al fallo muscular](#Como_llegar_al_fallo_muscular 'Cómo llegar al fallo muscular')
- [Ejercicios para llegar al fallo muscular](#Ejercicios_para_llegar_al_fallo_muscular 'Ejercicios para llegar al fallo muscular')
...
![entrenamiento militar al fallo](https://pau.ninja/wp-content/uploads/2022/10/entrenamiento-militar-al-fallo.png)
...
![Arthur Jones](https://pau.ninja/wp-content/uploads/2022/10/Arthur-Jones.jpeg)
...
Podemos llegar al fallo muscular en cualquier ejercicio, pero yo me centro en hacerlo con aquellos que tenga una [mayor conexión mente-músculo](https://pau.ninja/conexion-mente-musculo/).
