---
title: "Stop Loss el arte de colocar tus pérdidas donde debas"
...
- [Qué es una orden stop loss](#Que_es_una_orden_stop_loss 'Qué es una orden stop loss')
  - [Diferencia entre stop loss y stop limit](#Diferencia_entre_stop_loss_y_stop_limit 'Diferencia entre stop loss y stop limit')
  - [Cómo calcular el stop loss](#Como_calcular_el_stop_loss 'Cómo calcular el stop loss')
  - [Por qué es tan difícil colocar un Stop Loss](#Por_que_es_tan_dificil_colocar_un_Stop_Loss 'Por qué es tan difícil colocar un Stop Loss')
- [Cómo poner un Stop Loss correctamente](#Como_poner_un_Stop_Loss_correctamente 'Cómo poner un Stop Loss correctamente')
  - [Entiende por qué lo pones](#Entiende_por_que_lo_pones 'Entiende por qué lo pones')
  - [Debe ser proporcional a lo que esperes ganar](#Debe_ser_proporcional_a_lo_que_esperes_ganar 'Debe ser proporcional a lo que esperes ganar')
  - [Menos porcentaje pero más gráfico](#Menos_porcentaje_pero_mas_grafico 'Menos porcentaje pero más gráfico')
- [Dónde poner el Stop Loss según tu estrategia](#Donde_poner_el_Stop_Loss_segun_tu_estrategia 'Dónde poner el Stop Loss según tu estrategia')
  - [La regla del breakeven](#La_regla_del_breakeven 'La regla del breakeven')
  - [El free-roll](#El_free-roll 'El free-roll')
  - [El stop trasero](#El_stop_trasero 'El stop trasero')
- [Las reglas para colocar un stop loss](#Las_reglas_para_colocar_un_stop_loss 'Las reglas para colocar un stop loss')
  - [Nunca olvides tu orden limitada](#Nunca_olvides_tu_orden_limitada 'Nunca olvides tu orden limitada')
  - [Te presente la etapa del activo](#Te_presente_la_etapa_del_activo 'Te presente la etapa del activo')
  - [Orden de venta en Etapa 1-2](#Orden_de_venta_en_Etapa_1-2 'Orden de venta en Etapa 1-2')
...
### Por qué es tan difícil colocar un _Stop Loss_
...
Tanto en movimientos de corto plazo como de largo, porque si intentas cazar una subida de varios meses por ejemplo con [el método de Weinstein](https://pau.ninja/metodo-stan-weinstein/) entonces necesitas dar espacio a tu movimiento para que también corrija.
...
Una de las estrategi [todos los libros de trading que deberías leer en 2024](https://pau.ninja/mejores-libros-de-trading/) es el hecho de poner un *stop loss* en **absolutamente todas tus órdenes**.
...
El libro que personalmente lo explicó mejor fue el segundo de Mark Minervini, en el que [habla de la gestión de riesgo en el trading](https://pau.ninja/gestion-de-riesgo-en-el-trading/) de una forma magnífica.
...
La primera estrategia para vender acciones con _stop loss_ es la regla del _breakeven_ o la que podríamos traducir como la *regla mejor* (_the better rule_).
...
Partiendo de la base de que cuando una posición se mueve 2 o 3 veces por delante de nuestro _Stop Loss_ entonces nos da mucha flexibilidad…

Tanto para acertarla como para cagarla.

Si por ejemplo estamos operando con un stop del 7%, una opción es vender la mitad y subir nuestro _stop_ a _breakeven_. Esto hace que estés *free-rolling* con la otra mitad.
...
En este caso pondríamos el *stop-loss* justo debajo del suelo más reciente del último balanceo/_swing_ que ha hecho que en este caso será sobre 40€.
