...
Después de [leer los mejores libros de trading](https://pau.ninja/mejores-libros-de-trading/) (#598) pensaba tener todas las armas necesarias para quedarme en la posición hasta que fuera necesario pero…

Poco tardé en darme cuenta que en los activos en los que invertía, mi [estrategia de gestión de riesgo](https://pau.ninja/gestion-de-riesgo-en-el-trading/) tenía que ser mucho más permisiva y flexible.
...
Ahí recibí una buena h0stia a favor [del trading minimalista](https://pau.ninja/trading-minimalista/) y más de largo plazo, en el que los gráficos no eran ni en diario y a penas en semanal, sino en **mensual**.
...
- [Diferencia entre soporte y resistencia](#Diferencia_entre_soporte_y_resistencia 'Diferencia entre soporte y resistencia')
  - [Qué es una resistencia en trading](#Que_es_una_resistencia_en_trading 'Qué es una resistencia en trading')
  - [Para qué sirve la resistencia](#Para_que_sirve_la_resistencia 'Para qué sirve la resistencia')
  - [Qué es el soporte en trading](#Que_es_el_soporte_en_trading 'Qué es el soporte en trading')
  - [Para qué sirve el soporte](#Para_que_sirve_el_soporte 'Para qué sirve el soporte')
- [Cómo identificar soporte y resistencia en trading](#Como_identificar_soporte_y_resistencia_en_trading 'Cómo identificar soporte y resistencia en trading')
  - [Utiliza el máximo y mínimo](#Utiliza_el_maximo_y_minimo 'Utiliza el máximo y mínimo')
  - [Mira el gráfico en alta temporalidad](#Mira_el_grafico_en_alta_temporalidad 'Mira el gráfico en alta temporalidad')
  - [Recuerda los básicos](#Recuerda_los_basicos 'Recuerda los básicos')
- [Cómo identificar la resistencia](#Como_identificar_la_resistencia 'Cómo identificar la resistencia')
- [Cómo identificar el soporte](#Como_identificar_el_soporte 'Cómo identificar el soporte')
- [Ejercicios para colocar soporte y resistencia](#Ejercicios_para_colocar_soporte_y_resistencia 'Ejercicios para colocar soporte y resistencia')
- [Cómo usar soporte para posiciones](#Como_usar_soporte_para_posiciones 'Cómo usar soporte para posiciones')
  - [Utilizar el soporte para vender](#Utilizar_el_soporte_para_vender 'Utilizar el soporte para vender')
  - [Nunca usaremos números exactos](#Nunca_usaremos_numeros_exactos 'Nunca usaremos números exactos')
...
Imaginemos la resistencia como un *techo* en el que cada vez que queremos pasar, hay montón de presión vendedora, como si fuera la gravedad que se va haciendo más pesada y nos impide avanzar más.
...
El soporte o *suelo* es la fuerza compradora.
...
Es importante que las identifiquemos para [aprender a colocar el _stop loss_](https://pau.ninja/donde-colocar-el-stop-loss/) correctamente, que es esta orden que nos vende automáticamente si pasa del precio que le hemos indicado.
...
## Cómo identificar soporte y resistencia en trading

Claro la pregunta es dónde está la resistencia y el soporte. El techo y suelo del precio.

Queremos saberlo para aplicar estrategias tanto para [comprar acciones](https://pau.ninja/cuando-comprar-acciones/) o criptomonedas, como para saber [en qué momento vender](https://pau.ninja/cuando-vender-acciones/).
...
Es decir una vez hemos aprendido [como leer velas japonesas](https://pau.ninja/como-leer-velas-japonesas/), ¿realmente es igual de relevante todo lo que nos dice? ¿O simplemente nos sirve para saturarnos de más datos la mente y que así tomemos peores decisiones?

![partes de las velas japonesas](https://pau.ninja/wp-content/uploads/2024/03/partes-de-las-velas-japonesas.jpeg)

Vayamos a la esencia del [trading minimalista](https://pau.ninja/trading-minimalista/) para intentar responder la siguiente pregunta: ¿qué tipo de información que nos dan las velas o las barras **podemos omitir** y sin embargo quedarnos igualmente con la misma información relevante?
...
Tanto en soportes, como resistencias, como [en patrones de velas de cambio de tendencia](https://pau.ninja/patrones-velas-cambio-tendencia/): cuanto más alejado en el tiempo el gráfico, más en serio nos tenemos que tomar un patrón que se vaya formando en el gráfico.
...
## Cómo identificar la resistencia
...
![mínima menor que mínima](https://pau.ninja/wp-content/uploads/2024/05/minima-menor-que-minima.png)
...
![resistencia acción](https://pau.ninja/wp-content/uploads/2024/05/resistencia-accion.png)

Esta será la resistencia a partir de ahora, pero acordaros que también la llamaremos *punto A*.
...
Y aquí recordamos nuestra frasecita de *el soporte será la mínima comprendida entre el punto A (resistencia) y su ruptura*.

![dónde está el soporte](https://pau.ninja/wp-content/uploads/2024/05/donde-esta-el-soporte.png)
...
![soporte de una acción](https://pau.ninja/wp-content/uploads/2024/05/soporte-de-una-accion.png)

Pues este es el soporte o el *suelo* de nuestra cripto o acción.
...
Aunque siempre puedes volver *aquí* para acordarte de cómo acordarte de dónde poner el soporte y la resistencia, y aunque haya programas que te lo están colocando en todo momento de forma automática, es importante que **no lo dejemos al azar**.

Cuando aprendí cómo poner el techo y el suelo de _mi casa_ (el activo en el que estoy), me puse manos a la obra a construir varias casas en las próximas semanas.

¿Por qué? Pues porque considero que [la práctica deliberada](https://pau.ninja/practica-deliberada/) (#604) es vital en cualquier ámbito pero más cuando se trata de nuestro dinero.

Aunque haya *software* que lo haga para nosotros, ¿y si está programado mal o no lo hace cómo nosotros queremos? Quizás queremos una temporalidad que el software no permite.
...
> Por esto cuando en el mercado sucede algo *arriba* nosotros hacemos algo *abajo*. Y cuando en el mercado sucede algo *abajo* nosotros hacemos algo *arriba*.
...
![poniendo soporte en bolsa](https://pau.ninja/wp-content/uploads/2024/05/poniendo-soporte-en-bolsa.png)

Pero nosotros diremos…

_Sí, sí, no me entretengas, a ver dónde el soporte_.

Oh también un *mira, mira que caigo, eh!*

![poniendo resistencia en bolsa](https://pau.ninja/wp-content/uploads/2024/05/poniendo-resistencia-en-bolsa.png)
...
Para no poner un *stop loss* que sea tan alejado de la cripto.
...
Por esto tenemos que ser más permisivos. Especialmente si queremos saber [cuando vender criptomonedas](https://pau.ninja/cuando-vender-acciones/) que no sean Bitcoin.

Porque la volatilidad de Bitcoin ha ido reduciéndose hasta llegar a niveles de empresas americanas. Llegando hoy a un 2-3%[1](<javascript:void(0)>)“Bitcoin Volatility Index – Charts vs Dollar & More.” 2014. Bitbo.io.
...
¿Y eso por qué es? Por algo que [el trader legendario Jesse Livermore](https://pau.ninja/jesse-livermore-trading/) (#590) ya comentaba en sus libros. Por un factor puramente psicológico.
