...
Pues, ¿te puedes creer que hay personas que *no* soltarían su liana?

Los adeptos a los [fondos indexados](https://pau.ninja/fondos/) siguen convencidos que hay que mantenerse agarrado a la liana aunque se les termine el *momentum* incluso cuando es claro que quedarse cogido significa no moverse, o incluso moverse hacia atrás.

> En el fondo aprendemos de *trading*, de análisis técnico para aprender a identificar mejor, a ser más precisos en saber cuando una liana se le está acabando el impulso.
...
Y dirás, *vale Pau, pero ¿qué tienen que ver las lianas y con los ETF apalancados?*
...
Las que tarde o temprano te permitirán coger muchísimas más velocidad gracias a este impulso, pero lógicamente si no tienes la suficiente vista para saber cuando soltarlas para coger otra o descansar, puedes terminar con una buena *h0stia*.
...
- [Qué es un ETF apalancado](#Que_es_un_ETF_apalancado 'Qué es un ETF apalancado')
  - [Cómo funciona un ETF apalancado](#Como_funciona_un_ETF_apalancado 'Cómo funciona un ETF apalancado')
  - [Costes de un ETF apalancado](#Costes_de_un_ETF_apalancado 'Costes de un ETF apalancado')
  - [Por qué apalancados](#Por_que_apalancados 'Por qué apalancados')
- [Desventajas de los ETF apalancados](#Desventajas_de_los_ETF_apalancados 'Desventajas de los ETF apalancados')
- [¿Qué apalancamiento es mejor?](#%C2%BFQue_apalancamiento_es_mejor '¿Qué apalancamiento es mejor?')
- [La mejor manera de operar ETFs apalancados](#La_mejor_manera_de_operar_ETFs_apalancados 'La mejor manera de operar ETFs apalancados')
- [Lista de los mejores ETF apalancados](#Lista_de_los_mejores_ETF_apalancados 'Lista de los mejores ETF apalancados')
  - [ETF apalancado del NASDAQ](#ETF_apalancado_del_NASDAQ 'ETF apalancado del NASDAQ')
  - [ETF apalancado del SP500](#ETF_apalancado_del_SP500 'ETF apalancado del SP500')
  - [ETF apalancado de largo plazo](#ETF_apalancado_de_largo_plazo 'ETF apalancado de largo plazo')
  - [ETF apalancados x3](#ETF_apalancados_x3 'ETF apalancados x3')
  - [¿En qué ETF estoy invertido yo actualmente?](#%C2%BFEn_que_ETF_estoy_invertido_yo_actualmente '¿En qué ETF estoy invertido yo actualmente?')
- [Estrategia para invertir con ETF apalancados](#Estrategia_para_invertir_con_ETF_apalancados 'Estrategia para invertir con ETF apalancados')
...
Lo que pasa es que su precio refleja lo que hay *dentro* de este ETF (esta agrupación).
...
Multiplicará tanto tus ganancias como tus pérdidas, pero lo bueno es que en el ratio de riesgo-recompensa, son perfectos para obtener ganancias increíbles, con pérdidas *no tan increíbles* (lo cual es bueno).

### Cómo funciona un ETF apalancado

Al contrario que otras formas de apalancamiento, con los ETF no necesitas pedir dinero prestado de tu _broker_, sino que el ETF tiene *apalancamiento implícito*.

Por ejemplo un ETF del S&P 500 como el SPYU, te da automáticamente un apalancamiento de 4x.

Pero pensad que este tipo de apalancamiento también es más barato que pedir dinero a tu *broker* con una cuenta con margen.
...
Y lo bueno es que en comparación a sí utilizas apalancamiento de tu *broker*, te sale **mucho más barato usar el apalancamiento de los propios ETF**.
...
Si haces una búsqueda rápida por la web encontrarás montones de titulares totalmente en contra de los ETF apalancados.
...
![titulares etf apalancados](https://pau.ninja/wp-content/uploads/2024/06/titulares-etf-apalancados.png)

Imagen: recopilación de titulares en contra de los ETFs apalancados.

Pero antes un recordatorio muy rápido que sólo [ser diferente te hará especial](https://pau.ninja/ser-diferente-te-hace-especial/), es decir…

¿A caso no querríamos hacer lo contrario que el 97% de la gente, si está demostrado que el 97% de la gente pierde dinero?

El primer argumento en contra de los ETF apalancados es la volatilidad, pero si la volatilidad fuese realmente una *comedora* de ganancias, entonces los fondos, índices o cualquier acción sin apalancamiento tampoco serían recomendables para [estrategias de holdear criptomonedas](https://pau.ninja/que-es-holdear-criptomonedas/), acciones o lo que fuese.
...
En un paper de Tony Cooper crearon un modelo simulado que podemos aplicar para determinar el apalancamiento ideal para cualquier valor.[1](<javascript:void(0)>)Cooper, Tony. 2010. “Alpha Generation and Risk Smoothing Using Managed Volatility.” SSRN Electronic Journal. doi:https://doi.org/10.2139/ssrn.1664823. ‌
...
Demasiado poco apalancamiento falla en capitalizar los retornos positivos esperados del apalancamiento, pero según este paper con demasiada se convierte en demasiado arrastre de volatilidad.
...
![mejor apalancamiento para etf](https://pau.ninja/wp-content/uploads/2024/06/mejor-apalancamiento-para-etf.png)

Pero lo que es muy importante determinar aquí, es que…

esta simulación de los 135 años está **incluyendo las recesiones** económicas importantes. Todos los *bear markets*.

Incluyendo el crash del 29, cuando el bueno de [Jesse Livermore](https://pau.ninja/jesse-livermore-trading/) estaba haciendo *short* al mercado ganando 100 millones y el propio JP Morgan le tuvo que pedir que por favor, parase.

Pero, ¿qué hay de los otros índices? ¿Fue el resultado más de lo mismo?

![etf apalancado índices](https://pau.ninja/wp-content/uploads/2024/06/etf-apalancado-indices.png)
...
La pregunta que nos deberíamos hacer ninjas de la vida, ¿sería posible usar el máximo de apalancamiento y que nos saliera un mejor resultado que estos *papers*?
...
- Hay todas las características de [acumulación Wyckoff](https://pau.ninja/acumulacion-wyckoff/)
...
Mi queja de [los fondos indexados](https://pau.ninja/fondos/) (#105) era que los fondos indexados en el fondo (juego de palabras intencionados) no superan la inflación. Bueno más bien dicho, no superan l[a devaluación de la moneda](https://pau.ninja/devaluacion-de-la-moneda/) (que no es lo mismo que inflación).

O en otras palabras: sigues igualmente perdiendo poder de compra.

Es decir que en los fondos indexados aunque vayas viendo más ganancias a largo plazo, tu poder de compra va bajando con el tiempo, simplemente por el hecho de que nuestro poder de compra se pierde mucho más rápido que lo que puedes ganar *indexándote* al mundo o lo que sea.
...
no digo que vaya a pillar el punto exacto, claro. Pero si que hay unas reglas interesantes de [cuando es el mejor momento para vender acciones](https://pau.ninja/cuando-vender-acciones/) (#618) que también aplicarían en las crypto y los ETF.
...
Quizás estoy en una situación en la que estoy en *cash*, esperando la oportunidad *técnica* para meterme en ellos.
...
En los últimos meses los [libros de trading que he leído](https://pau.ninja/mejores-libros-de-trading/) (#598) no sólo me han hecho un apasionado de la parte técnica de la bolsa y las criptomonedas, sino que me he asegurado de [retener la mejor información](https://pau.ninja/como-retener-mejor-la-informacion/) del tema (#588) lo máximo que he podido.
...
- [Cuando comprar acciones](https://pau.ninja/cuando-comprar-acciones/)
- [Cuando vender acciones](https://pau.ninja/cuando-vender-acciones/)
...
Sería un disparo en el pie comerme las bajadas que sugieren los *pro fondos indexados*, si podemos interpretar perfectamente cuando el mercado está en una Etapa 4 del [método de Weinstein](https://pau.ninja/metodo-stan-weinstein/), para entonces vender los ETF, y esperar a que sea una época más sana.
