---
title: "Grabar un podcast Lo indispensable y necesario (para todos los niveles)"
...
audioLink: https://pau.ninja/como-hacer-un-podcast/
slug: como-grabar-un-podcast
---

Ya sabes [cómo hacer un podcast](https://pau.ninja/como-hacer-un-podcast/), tienes el [equipo básico](https://pau.ninja/equipo-para-grabar-podcast/) y ahora….  toca lo divertido. Lo que has estado esperando. Ponerte los auriculares y escuchar tu propia voz. Que no te de vergüenza este narcisismos de _podcaster_. Es normal…
...
- [¿Qué necesitas para grabar un podcast?](#%C2%BFQue_necesitas_para_grabar_un_podcast '¿Qué necesitas para grabar un podcast?')
  - [Equipo básico](#Equipo_basico 'Equipo básico')
  - [Aplicaciones y software](#Aplicaciones_y_software 'Aplicaciones y software')
  - [Guión, escaleta o tema](#Guion_escaleta_o_tema 'Guión, escaleta o tema')
  - [Localización con buena acústica](#Localizacion_con_buena_acustica 'Localización con buena acústica')
- [Cómo grabar un podcast](#Como_grabar_un_podcast 'Cómo grabar un podcast')
  - [Descargar programa para grabar](#Descargar_programa_para_grabar 'Descargar programa para grabar')
  - [Grabar audio para el podcast](#Grabar_audio_para_el_podcast 'Grabar audio para el podcast')
  - [Usar Skype o Zoom para grabar a distancia](#Usar_Skype_o_Zoom_para_grabar_a_distancia 'Usar Skype o Zoom para grabar a distancia')
  - [Sincronizar los audios](#Sincronizar_los_audios 'Sincronizar los audios')
  - [Editar el audio del podcast](#Editar_el_audio_del_podcast 'Editar el audio del podcast')
- [¿Dónde alojar un podcast?](#%C2%BFDonde_alojar_un_podcast '¿Dónde alojar un podcast?')
  - [Anchor](#Anchor 'Anchor')
  - [Ivoox](#Ivoox 'Ivoox')
- [Crear RSS para podcast](#Crear_RSS_para_podcast 'Crear RSS para podcast')
- [Plataformas para subir podcast](#Plataformas_para_subir_podcast 'Plataformas para subir podcast')
  - [Subir podcast a Spotify](#Subir_podcast_a_Spotify 'Subir podcast a Spotify')
  - [Subir podcast a Ivoox](#Subir_podcast_a_Ivoox 'Subir podcast a Ivoox')
  - [Subir podcast a Apple Podcast](#Subir_podcast_a_Apple_Podcast 'Subir podcast a Apple Podcast')
  - [Subir podcast a Google Podcast](#Subir_podcast_a_Google_Podcast 'Subir podcast a Google Podcast')
  - [Subir podcast a YouTube](#Subir_podcast_a_YouTube 'Subir podcast a YouTube')
- [Consejos para grabar un podcast](#Consejos_para_grabar_un_podcast 'Consejos para grabar un podcast')
...
- **Presupuesto ajustado**
  ...
  - [Micrófono USB](https://pau.ninja/equipo-para-grabar-podcast/#Microfonos_para_grabar_podcast)
  - Ordenador

- **Presupuesto profesional**
  - [Micrófono dinámico](https://pau.ninja/equipo-para-grabar-podcast/#Microfonos_para_grabar_podcast)
  - [Audio interface](https://pau.ninja/equipo-para-grabar-podcast/#Interfaz_de_audio_USB)
...
Así que… lo que el presupuesto te permita. Peor sería no grabar nada con la excusa de «aún no tengo buen equipo…». El mundo **no** te está esperando. No vas a tener audiencia desde el episodio 1, así que **ponte a grabar sin excusas** y empieza a ver como te sientes, desde el episodio 1.
...
Puedes tener el mejor material, las aplicaciones calentitas a punto de darle al REC y… no saber de que hablar. Por experiencia propia los episodios *freestyle* pueden dar buenos resultados, pero normalmente acostumbramos a grabar con al menos una **semilla**. Una idea. Un tema en la cabeza.
...
![meme Arale micrófono](https://pau.ninja/wp-content/uploads/2021/02/meme-arale-microfono.jpeg)
...
![portátil editando podcast](https://pau.ninja/wp-content/uploads/2021/02/portatil-editando-podcast.png)

Esto de sincronizar sólo es necesario en el caso de que no tengas ningún micro profesional. Los [micrófonos USB](https://pau.ninja/equipo-para-grabar-podcast/#Microfonos_para_grabar_podcast) son baratos y en el caso de tenerlos el audio del Zoom nos dará el audio final bien hecho.
...
Como mi formato es *raw* (en crudo) a penas hago ediciones a menos que me lo pida el invitado que ha dicho algo que no le ha gustado o así, pero siempre sigo el mismo patrón: trocito + intro + episodio + outro.

![estructura podcast](https://pau.ninja/wp-content/uploads/2021/02/estructura-podcast.png)
...
![anchor](https://pau.ninja/wp-content/uploads/2021/02/anchor.png)
...
![ivoox](https://pau.ninja/wp-content/uploads/2021/02/ivoox.png)
...
Después si que es verdad que tendrás que darlo de alta en las plataformas de podcast más famosas como Spotify. En este caso hay que ir a [Podcasters](https://podcasters.spotify.com/) de Spotify y simplemente dar de alta el *feed* de nuestro podcast.
...
![horas de mas audiencia](https://pau.ninja/wp-content/uploads/2021/07/horas-de-mas-audiencia.png)
