...
![meme liquidez del trading](https://pau.ninja/wp-content/uploads/2024/06/meme-liquidez-del-trading.jpeg)
...
Algo que tiene todo el sentido del mundo si aceptamos que hay [manipulación del mercado](https://pau.ninja/manipulacion-del-mercado/) (#613) porque quien mueve el precio en realidad es un algoritmo masivo hecho para comerse todos los stop loss y órdenes que puedan de la gente que tiene pasta.
...
- [¿Qué es la liquidez?](#%C2%BFQue_es_la_liquidez '¿Qué es la liquidez?')
- [¿Dónde se encuentra la liquidez?](#%C2%BFDonde_se_encuentra_la_liquidez '¿Dónde se encuentra la liquidez?')
- [Tipos de liquidez](#Tipos_de_liquidez 'Tipos de liquidez')
  - [Interna](#Interna 'Interna')
  - [Externa](#Externa 'Externa')
  - [Máximos y mínimos antiguos](#Maximos_y_minimos_antiguos 'Máximos y mínimos antiguos')
  - [Máximos y mínimos (relativamente) iguales](#Maximos_y_minimos_relativamente_iguales 'Máximos y mínimos (relativamente) iguales')
- [Cómo predecir la pesca de liquidez](#Como_predecir_la_pesca_de_liquidez 'Cómo predecir la pesca de liquidez')
- [Cómo aplicar estos conceptos a la práctica](#Como_aplicar_estos_conceptos_a_la_practica 'Cómo aplicar estos conceptos a la práctica')
  - [Sesgo diario](#Sesgo_diario 'Sesgo diario')
  - [Continuation (continuación)](#Continuation_continuacion 'Continuation (continuación)')
  - [Reversión (reversal)](#Reversion_reversal 'Reversión (reversal)')
- [Niveles de liquidez más importantes](#Niveles_de_liquidez_mas_importantes 'Niveles de liquidez más importantes')
  - [Liquidez de la última semana](#Liquidez_de_la_ultima_semana 'Liquidez de la última semana')
  - [Liquidez del día anterior](#Liquidez_del_dia_anterior 'Liquidez del día anterior')
  - [Liquidez de las sesiones de trading](#Liquidez_de_las_sesiones_de_trading 'Liquidez de las sesiones de trading')
...
Cuando hablamos de _trading_ tipo diario como *scalping* (compras y ventas en cuestión de minutos o incluso segundos), operamos exclusivamente en mercados muy líquidos (tipo índices como el Nasdaq) en horarios donde sabemos que no tendremos problemas en comprar/vender posiciones porque habrá suficiente liquidez.

Pero ninja de la vida, no somos los únicos que queremos *cash*.

El algoritmo que lo mueve todo (…) también está buscando donde es la zona en la que la mayoría ha decidido [colocado _adecuadamente_ el _stop loss_](https://pau.ninja/donde-colocar-el-stop-loss/) (venta automática de seguridad) para así vendernos a todos automáticamente y que sea el mercado quien se quede con tu liquidez.
...
¿No te has dado cuenta que siempre que entras en una operación para hacer un *swing*, siempre te hacen saltar el *stop*, y el precio se va sin ti? Por esto es vital aprender a [cuando poner un _stop loss_](https://pau.ninja/cuando-poner-stop-loss/) y cuando no. Porque la mayoría ponen sus _stop loss_ en los mismos sitios y el algoritmo va a buscar esa liquidez.
...
![ejemplo fair value gap](https://pau.ninja/wp-content/uploads/2024/06/ejemplo-fair-value-gap.png)
...
El *trader* medio decidirá que el mejor sitio dónde colocar su *stop* es justo debajo del _swing low_.
...
![máximos y mínimos antiguos](https://pau.ninja/wp-content/uploads/2024/06/maximos-y-minimos-antiguos.png)

### Máximos y mínimos (relativamente) iguales

![máximos y mínimos relativamente iguales](https://pau.ninja/wp-content/uploads/2024/06/maximos-y-minimos-relativamente-iguales.png)
...
_Draw On Liquidity_ lo podemos traducir como *aprovechamiento de liquidez*. Aunque a mí me gusta más usar «comilona de liquidez» o «imán de liquidez» porque representa mejor de qué va todo esto.

- Este *draw on liquidity* es uno de los conceptos más importantes de Smart Money Concepts, pero para ver nuestras clases completas necesitas [ser miembro](#unirse).
...
Aquí será vital que sepamos [cómo leer velas japonesas](https://pau.ninja/como-leer-velas-japonesas/) (#602), porque necesitaremos interpretar si el precio cerró por encima o por debajo de la última vela (ahora lo vemos).
...
![ejemplo draw on liquidity](https://pau.ninja/wp-content/uploads/2024/06/ejemplo-draw-on-liquidity.png)
...
![ejemplo liquidez bajista](https://pau.ninja/wp-content/uploads/2024/06/ejemplo-liquidez-bajista.png)

Esta perla que os acabo de mencionar es vital para entender hacia donde irá el precio, porque además, gracias a lo que aprendimos de [la metodología Wyckoff](https://pau.ninja/metodo-wyckoff/) la fractalidad del tiempo también se aplica al mercado.
...
![reversión bajista de liquidez](https://pau.ninja/wp-content/uploads/2024/06/reversion-bajista-de-liquidez.png)
