---
title: "Si no es Bitcoin… ¿es shitcoin? ¿Bitcoin o Ethereum? ¿Quizás otras critpomonedas?"
...
[https://www.ivoox.com/si-no-es-bitcoin-es-shitcoin_md_80707456_wp_1.mp3](https://www.ivoox.com/si-no-es-bitcoin-es-shitcoin_md_80707456_wp_1.mp3)
...
Ethereum cumple una función central (irónicamente) en las finanzas descentralizadas (DeFi). Algo totalmente disruptor, pero ETH **no intenta competir con Bitcoin** en cuanto a [ser valor refugio/reserva de valor](https://pau.ninja/valores-refugio/).
...
![sistema solar Bitcoin](https://pau.ninja/wp-content/uploads/2021/11/sistema-solar-bitcoin.jpeg)
...
- [¿Bitcoin o Ethereum?](#%C2%BFBitcoin_o_Ethereum '¿Bitcoin o Ethereum?')
  - [Para invertir](#Para_invertir 'Para invertir')
  - [Para ahorrar](#Para_ahorrar 'Para ahorrar')
- [Características clave entre Bitcoin y Ethereum](#Caracteristicas_clave_entre_Bitcoin_y_Ethereum 'Características clave entre Bitcoin y Ethereum')
  - [Efecto red](#Efecto_red 'Efecto red')
  - [Herramienta](#Herramienta 'Herramienta')
  - [Seguridad](#Seguridad 'Seguridad')
  - [Adopción](#Adopcion 'Adopción')
- [La principal diferencia entre Bitcoin VS Ethereum](#La_principal_diferencia_entre_Bitcoin_VS_Ethereum 'La principal diferencia entre Bitcoin VS Ethereum')
  - [Ethereum es valor programable](#Ethereum_es_valor_programable 'Ethereum es valor programable')
  - [Bitcoin es soverano](#Bitcoin_es_soverano 'Bitcoin es soverano')
...
![bitcoin vs ethereum](https://pau.ninja/wp-content/uploads/2021/11/bitcoin-vs-ethereum.png)
...
Hasta ahora si queríamos ahorrar, **no podíamos**. Si dejábamos el dinero en el banco o bajo el colchón, la inflación y devaluación creados [por el sistema monetario de hoy](https://pau.ninja/sistema-monetario-actual/), se comían nuestro poder de compra.
...
> Si [compras Bitcoin](https://pau.ninja/invertir-en-bitcoins-forma-segura/) estás ahorrando. Si lo metes en Ethereum estás invirtiendo.
...
![btc vs bitcoin cash](https://pau.ninja/wp-content/uploads/2021/11/btc-vs-bitcoin-cash.jpeg)

Una copia de Bitcoin excepto con tamaño de bloques un poquito más grande. ¿Habéis visto lo que vale hoy Bitcoin Cash VS el [valor de Bitcoin hoy](https://pau.ninja/por-que-tiene-valor-el-bitcoin/#Que_valor_tiene_un_bitcoin)?
...
- La pala nos sirve para sacar más tierra que con nuestras manos.
...
Bitcoin está siguiendo un camino muy similar, y como no, mucho más rápidamente.
...
«A la otra cara de la… criptomoneda» la seguridad de Ethereum es mucho más cuestionable que la de Bitcoin. Con más flexibilidad hay más superficie de ataque para que los *hackers* encuentren agujeros como ya hicieron en 2016.
...
Por esto Bitcoin es el mayor libro contable descentralizado y más seguro del mundo. No hay nada igual para proteger información valiosa. Algo que comenté extensamente (#158) cuando hablé de lo [que es Bitcoin (para tontos)](https://pau.ninja/que-es-bitcoin-para-tontos/).
...
Los titulares podrán ser reales o falsos, pero no importaría.
