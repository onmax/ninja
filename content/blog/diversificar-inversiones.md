...
![pau ninja el país](https://pau.ninja/wp-content/uploads/2022/10/pau-ninja-elpais.jpg)
...
- [Aplicar las normas del sistema monetario](#Aplicar_las_normas_del_sistema_monetario 'Aplicar las normas del sistema monetario')
- [Seguir el curso de la historia monetaria](#Seguir_el_curso_de_la_historia_monetaria 'Seguir el curso de la historia monetaria')
- [No perder poder de compra](#No_perder_poder_de_compra 'No perder poder de compra')
- [Ahorrar a largo plazo](#Ahorrar_a_largo_plazo 'Ahorrar a largo plazo')
- [Batir la inflación](#Batir_la_inflacion 'Batir la inflación')
- [Mitigar el riesgo](#Mitigar_el_riesgo 'Mitigar el riesgo')
- [Entender en qué invertimos](#Entender_en_que_invertimos 'Entender en qué invertimos')
- [Expectativa de futuro](#Expectativa_de_futuro 'Expectativa de futuro')
- [Paso natural de las cosas](#Paso_natural_de_las_cosas 'Paso natural de las cosas')
- [El juego terminará en algún momento](#El_juego_terminara_en_algun_momento 'El juego terminará en algún momento')
...
![](https://pau.ninja/wp-content/uploads/2021/01/diversificar-inversiones.png)
...
Pregúntaselo a los 130 millones de ciudadanos que vivieron [la economía romana](https://pau.ninja/la-economia-en-el-imperio-romano/) (#373). Gobernantes creando monedas de la nada que llevó a una hiperinflación encubierta. Como ahora.
...
Con eso se consigue un control de la población occidental pero también que nuestro libido, nuestro _drive_, nuestra asertividad esté lo más capada posible para que nadie piense ni tenga ganas de revolucionarse.
...
Por esto para mí me parece más tontería apoyar la diversificación pensando en estudios y *papers* empíricos **actuales** de la última década. Es como intentar predecir el precio de una acción a toro pasado. El mundo va cambiando demasiado rápido para ceñirnos en esto. Alejémonos un poco con la lupa.
...
¿Qué harías? ¿Ahorrarías o invertirías? Quizás si fueras una persona conservador no te interesaría para nada intercambiar riesgo (paz mental) a cambio de obtener rentabilidad futura.
...
![acumulación de bitcoin](https://pau.ninja/wp-content/uploads/2021/11/acumulacion-bitcoin.png)
...
Vamos a hacer vista de pájaro, el famoso *zoom out*, tirar atrás por la lupa para ver que aunque te den un 15% con la divisa de tu país, **el poder de compra que pierdes es mucho mayor por el hecho de tener un activo en dólares o euros**.
...
![realidad inflación tweet](https://pau.ninja/wp-content/uploads/2022/10/realidad-inflacion-tweet.png)
...
¿Sabéis a cómo llamo esto? A quedarse igual. A dar un paso atrás y otro hacia adelante.
...
No es que tenga que confiar en una empresa o una institución, y en los humanos que la forman. No. Tengo que confiar en que Bitcoin [cumple con las propiedades del dinero](https://pau.ninja/propiedades-del-dinero/) duro. Supongo que por esto, desde que tengo todo a Bitcoin **he dormido más tranquilo** que cuando lo tenía todo a fondos indexados.
...
Pienso en el paso natural de las cosas.
...
![tipos civilizaciones](https://pau.ninja/wp-content/uploads/2021/01/tipos-civilizaciones.png)
