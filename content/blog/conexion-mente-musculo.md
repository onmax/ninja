---
title: "Mente-músculo: la conexión que no tuviste con tu ex (qué es, cómo conseguirla y cómo mejorarla)"
...
![meme conexión mente músculo](https://pau.ninja/wp-content/uploads/2022/10/meme-conexion-mente-musculo.jpeg)
...
- [¿Qué es la conexión mente-músculo?](#%C2%BFQue_es_la_conexion_mente-musculo '¿Qué es la conexión mente-músculo?')
  - [Cómo saber si tengo conexión mente-músculo](#Como_saber_si_tengo_conexion_mente-musculo 'Cómo saber si tengo conexión mente-músculo')
  - [Ejemplo práctico](#Ejemplo_practico 'Ejemplo práctico')
  - [Por qué desarrollar conexión mente-músculo](#Por_que_desarrollar_conexion_mente-musculo 'Por qué desarrollar conexión mente-músculo')
- [Cómo sentir la conexión mente-músculo](#Como_sentir_la_conexion_mente-musculo 'Cómo sentir la conexión mente-músculo')
  - [En principiantes](#En_principiantes 'En principiantes')
  - [En intermedios](#En_intermedios 'En intermedios')
  - [En avanzados](#En_avanzados 'En avanzados')
- [Cómo mejorar la conexión mente-músculo](#Como_mejorar_la_conexion_mente-musculo 'Cómo mejorar la conexión mente-músculo')
  - [Corregir la técnica](#Corregir_la_tecnica 'Corregir la técnica')
  - [Tocar el músculo trabajado](#Tocar_el_musculo_trabajado 'Tocar el músculo trabajado')
  - [Acercarnos más al fallo](#Acercarnos_mas_al_fallo 'Acercarnos más al fallo')
  - [Hacer una serie pesada y bajar de peso](#Hacer_una_serie_pesada_y_bajar_de_peso 'Hacer una serie pesada y bajar de peso')
  - [Elige otro ejercicio](#Elige_otro_ejercicio 'Elige otro ejercicio')
- [Por qué cultivar esta técnica](#Por_que_cultivar_esta_tecnica 'Por qué cultivar esta técnica')
...
![meme to masao](https://pau.ninja/wp-content/uploads/2022/10/meme-to-masao.jpeg)

Descripción gráfica: to-masao.

Lo que nos pone cuadrados son los secuestro de metabolitos en el músculo (que está bien documentado por la ciencia[1](<javascript:void(0)>)Tesis doctoral ESTUDIO DE FATIGA MUSCULAR MEDIANTE ESTIMULACIÓN DE BAJA FRECUENCIA José Humberto Maulén Arroyo ) pero con el que prestamos más atención es **la tensión mecánica**.
...
Cuando entrenamos para [ganar masa muscular](https://pau.ninja/entrenamiento-ganar-masa-muscular/) buscamos crear estímulo de crecimiento. La conexión mente-músculo es relevante aquí porque forma parte de la magnitud del estímulo que recibiremos. Me explico.
...
La lección es la [sobrecarga progresiva en el gym](https://pau.ninja/sobrecarga-progresiva-gym/) y fuerza. Es decir, ir subiendo pesos o repeticiones en **cada maldito entrenamiento**. Tiene que haber mejora en cada sesión.
...
Es difícil de explicar. Pero imagina que me sacaba 20kg en press de hombros sentado, por cierto es un ejercicio que he dejado de hacer porque ahora me centro en los [fondos en paralelas](https://pau.ninja/fondos-en-paralelas/) y me he dado cuenta que si bajo de la paralela (con los hombros), **es el único entreno de hombros que necesito**.
