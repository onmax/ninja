---
title: "Método Wyckoff el arte de interpretar el gráfico"
...
audioLink: https://pau.ninja/se-puede-vivir-del-trading/
slug: metodo-wyckoff
---

Los caminos que tomé para [vivir del trading](https://pau.ninja/se-puede-vivir-del-trading/) me llevaron a aprender la metodología Wyckoff, con la que en seguida me di cuenta que era lo mismo que [el método de Stan Weinstein](https://pau.ninja/metodo-stan-weinstein/) con la diferencia de que Weinstein lo había simplificado.

Y a pesar de que en general estoy muy a favor de eliminar el ruido de cualquier disciplina, incluyendo de hacer [hacer el _trading_ lo más minimalista posible](https://pau.ninja/trading-minimalista/), gracias a Wyckoff me di cuenta de que poner más información en lo que veo en el gráfico me ayudó mucho.
...
Wyckoff elimina muchos factores de incertidumbre que nos harían no saber cómo o por qué estamos operando, algo que hace que muchos *traders* dejen factores como la [gestión de riesgo en el trading](https://pau.ninja/gestion-de-riesgo-en-el-trading/) a la pura suerte.
...
- [Quien fue Richard Wyckoff](#Quien_fue_Richard_Wyckoff 'Quien fue Richard Wyckoff')
- [Ciclo del precio según Wyckoff](#Ciclo_del_precio_segun_Wyckoff 'Ciclo del precio según Wyckoff')
- [Los pasos de mercado en el método Wyckoff](#Los_pasos_de_mercado_en_el_metodo_Wyckoff 'Los pasos de mercado en el método Wyckoff')
  - [Parada preliminar](#Parada_preliminar 'Parada preliminar')
  - [Climax](#Climax 'Climax')
  - [Reacción](#Reaccion 'Reacción')
  - [Prueba secundaria](#Prueba_secundaria 'Prueba secundaria')
  - [SOS & SOW](#SOS_SOW 'SOS & SOW')
  - [Test genérico](#Test_generico 'Test genérico')
  - [Falsa ruptura](#Falsa_ruptura 'Falsa ruptura')
  - [Ruptura](#Ruptura 'Ruptura')
  - [Confirmación](#Confirmacion 'Confirmación')
...
![richard wyckoff](https://pau.ninja/wp-content/uploads/2024/06/richard-wyckoff.jpeg)
...
A raíz de observer los precios, de ver como actuaban JP Morgan y el legendario *trader* [Jesse Livermore](https://pau.ninja/jesse-livermore-trading/) (#590), terminó desarrollando el Método Wyckoff, pavimentando unas leyes, principios y técnicas que han perdurado desde el siglo XX.
...
Estos eventos son los que acompañan cada una de las [5 fases del mercado según Wyckoff](https://pau.ninja/fases-del-mercado-segun-wyckoff/) en los que vale la pena que indaguemos para poder identificarlos bien.
...
Algo que lo vemos predominantemente de dos maneras distintas, y para verlo claramente tendremos que [aprender a leer velas japonesas](https://pau.ninja/como-leer-velas-japonesas/) (#602).
...
Esta divergencia es una de las cosas que [nos enseñan las leyes Wyckoff](https://pau.ninja/leyes-de-wyckoff/) (#610).
...
Es un evento crítico porque no sólo confirma el evento climático anterior, sino que también representa un _cambio de carácter_ o de personalidad (_choch_, se le llama en trading, que son las siglas de *change of character*).
...
![reacumulación wyckoff](https://pau.ninja/wp-content/uploads/2024/06/reacumulacion-wyckoff.jpg)
...
Pero las funciones de esta reacción no son pocas porque gracias a este evento ya podemos ver donde están las fronteras ([soportes y resistencias en trading](https://pau.ninja/soporte-y-resistencia-trading/)) de toda la estructura lateral.
...
Sucede porque en los extremos del rango, distintos tipos de _traders_ ponen un montón de órdenes, creando lo que se llama una *zona de liquidez*.
...
- Hacer que se activen las órdenes [colocadas de _stop loss_](https://pau.ninja/donde-colocar-el-stop-loss/) de otros traders que se querían proteger hasta esos niveles.
...
Esto es importante vigilando para tener en cuenta la relación volumen-precio y oferta-demanda, en el sentido de que hay una relación inversa en lo agresiva que sea una ruptura falsa como un _spring_ o *upthrust*.
