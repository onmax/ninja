---
title: "Earthing: desinflamación con los pies en el suelo Los beneficios del grounding"
...
Igual cuando le preguntaron al artista indio MF Husain (de puntos, no de plumas) cuál era el secreto de la longevidad, el tipo dijo «[comer menos](https://pau.ninja/comer-una-vez-al-dia/)… y caminar descalzo». El pintor murió a los 95 años de juventud acumulada.
...
Pues resulta que el llamado _earthing_ o *grounding* está bien documentado científicamente.
...
![evidencia científica grounding](https://pau.ninja/wp-content/uploads/2022/08/evidencia-cientifica-grounding.png)
...
- [Qué es el grounding o earthing](#Que_es_el_grounding_o_earthing 'Qué es el grounding o earthing')
- [Beneficios científicos del earthing o grounding](#Beneficios_cientificos_del_earthing_o_grounding 'Beneficios científicos del earthing o grounding')
  - [Tiene propiedades antioxidantes](#Tiene_propiedades_antioxidantes 'Tiene propiedades antioxidantes')
  - [Aumenta la calidad de tu sueño](#Aumenta_la_calidad_de_tu_sueno 'Aumenta la calidad de tu sueño')
  - [Reduce los niveles de estrés](#Reduce_los_niveles_de_estres 'Reduce los niveles de estrés')
  - [Mejora la recuperación de los músculos](#Mejora_la_recuperacion_de_los_musculos 'Mejora la recuperación de los músculos')
  - [Favorece varios de marcadores de salud](#Favorece_varios_de_marcadores_de_salud 'Favorece varios de marcadores de salud')
- [Técnica de grounding](#Tecnica_de_grounding 'Técnica de grounding')
- [Cómo medir el voltaje del cuerpo humano](#Como_medir_el_voltaje_del_cuerpo_humano 'Cómo medir el voltaje del cuerpo humano')
  - [Compra un medidor de voltaje](#Compra_un_medidor_de_voltaje 'Compra un medidor de voltaje')
  - [Cómo medir voltaje con multimetro](#Como_medir_voltaje_con_multimetro 'Cómo medir voltaje con multimetro')
  - [Muévete para ver el voltaje en distintos entornos](#Muevete_para_ver_el_voltaje_en_distintos_entornos 'Muévete para ver el voltaje en distintos entornos')
- [Cuánto voltaje tiene el cuerpo humano](#Cuanto_voltaje_tiene_el_cuerpo_humano 'Cuánto voltaje tiene el cuerpo humano')
- [Cómo practicar el earthing casero](#Como_practicar_el_earthing_casero 'Cómo practicar el earthing casero')
  - [Utilizar conductores](#Utilizar_conductores 'Utilizar conductores')
  - [Conéctate utilizando tuberías](#Conectate_utilizando_tuberias 'Conéctate utilizando tuberías')
  - [Pulseras antiestáticas](#Pulseras_antiestaticas 'Pulseras antiestáticas')

## Qué es el _grounding_ o *earthing*

El *earthing* (también conocido como _grounding_) es la práctica del contacto del cuerpo humano con la superficie de la Tierra para que haya descarga de electricidad. El contacto puede ser directo (como caminar descalzo) o indirecto con materiales conductores que transfieren la energía del suelo al cuerpo.

## Beneficios científicos del _earthing_ o *grounding*
...
![protección de órganos](https://pau.ninja/wp-content/uploads/2022/08/proteccion-de-organos.png)
...
Y ojo porque lo reportaron casi todos los que participaron.
...
El *earthing* es tan fácil como irte a la playa, o hasta al jardín o a la montaña descalzo. Puedes incluso probar de ponerte en contacto total con la tierra sin toallas. Más superficie.
...
El *earthing* o _grounding_ nos da la posibilidad de descargarde la sobrecarga de energía excesiva que nos viene de trabajar en una oficina, vivir en una casa electrificada llena de [radiaciones ionizantes en casa](https://pau.ninja/radiaciones-ionizantes-en-casa/), y del exceso de tecnología en general.
...
### Compra un medidor de voltaje

Pero este medidor es algo distinto al típico para ver los [efectos de las ondas electromagnéticas](https://pau.ninja/efectos-ondas-electromagneticas/) que ya vimos para ver las radiaciones que hay en casa.

Ahora mismo rebajado

[![AstroAI AM33D Multímetro Digital de 2000 Cuentas, Polímetro Profesional, Voltímetro, Tester,...](https://pau.ninja/wp-content/plugins/aawp/public/image.php?url=YUhSMGNITTZMeTl0TG0xbFpHbGhMV0Z0WVhwdmJpNWpiMjB2YVcxaFoyVnpMMGt2TlRGc2JtaHdTRWhyVjB3dVgxTk1NVFl3WHk1cWNHYz18MTcyODkwNjAwNQ=)](https://www.amazon.es/dp/B01ISAMUA6?tag=pau-ninja-21&linkCode=ogi&th=1&psc=1 'AstroAI AM33D Multímetro Digital de 2000 Cuentas, Polímetro Profesional, Voltímetro, Tester,...')
...
En cambio cuando estés en cemento, en hormigón, lo que verás en la pantalla será algo del rollo 3-4, que no deja de significar «estar cargado positivamente» y puede llegar rollo 30 (muy alto).
...
![meme medir voltios cuerpo humano](https://pau.ninja/wp-content/uploads/2022/08/meme-medir-voltios-cuerpo-humano.jpeg)
...
![varilla de puesta a tierra](https://pau.ninja/wp-content/uploads/2022/08/varilla-de-puesta-a-tierra.jpeg)
...
Técnicamente hablando si no hay intermediarios en la conexión, todos los radiadores que tienes en casa deberían estar haciendo *grounding*… algo que podemos poner a prueba y ver qué sucede si tocas las tuberías de cobre con [el medidor de voltaje](https://pau.ninja/earthing-grounding-que-es/#Compra_un_medidor_de_voltaje) que hemos visto antes. ¿Cómo?
...
Y pum. Si está conectado directamente con el suelo **saldrás en negativo**. Estás en modo *earthing*. Estás haciendo _grounding_.
...
[![Pulseras Antiestaticas - 3 Pack – Antiestaticos reutilizables pulseras equipadas con conexión a...](https://pau.ninja/wp-content/plugins/aawp/public/image.php?url=YUhSMGNITTZMeTl0TG0xbFpHbGhMV0Z0WVhwdmJpNWpiMjB2YVcxaFoyVnpMMGt2TlRGQk56ZEtVMmRxUzB3dVgxTk1NVFl3WHk1cWNHYz18MTcyODkwNjAwNQ=)](https://www.amazon.es/dp/B017164JHA?tag=pau-ninja-21&linkCode=ogi&th=1&psc=1 'Pulseras Antiestaticas - 3 Pack – Antiestaticos reutilizables pulseras equipadas con conexión a...')
...
10,49 € ![Amazon Prime](https://pau.ninja/wp-content/plugins/aawp/assets/img/icon-check-prime.svg)
...
Básicamente pones como un cable conductor que va enterrado y anclado a la tierra de tu jardín, y cuando te vas a dormir, pues conectas la pulsera al cable.
