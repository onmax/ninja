---
title: "Velas japonesas o cómo leer el precio en análisis técnico"
...
![sombra vela en candelabro](https://pau.ninja/wp-content/uploads/2024/03/sombra-vela-en-candelabro.jpg)
...
Seguro que tampoco es casualidad que ahora que las cripto están tan de moda, la palabra candela*bro* termine con -bro…
...
Puedes expandir el resto de la introducción pulsando aquí.
...
> Gracias al *big data*, en la actualidad hemos podido confirmar analizando 5 millones de velas en mercados alcistas y bajistas, que las formas que algunas velas tomas, sí sirven para interpretar el camino del precio que tomará un valor.
...
> Y es que los patrones se desarrollan por lo que hacen los *traders*. Es decir, lo que hacen las *personas*.

Las mismas personas que chillarían y saltarían en una habitación a la que han tirado un petardo.

Esta fue una de las lecciones del [trader Jesse Livermore](https://pau.ninja/jesse-livermore-trading/), que ya en la década de los 20 se hizo *milmillonario*, ya alegando como la bolsa siempre se ha repetido en patrones y siempre se repetirá porque la mueven las personas.
...
Te expresan el comportamiento de esas personas *en una habitación con petardos* que están comprando y vendiendo.

Además si hacemos vista de pájaro, vemos que cuanto más atrás vamos con el gráfico (la temporalidad, el periodo de tiempo) más sube la probabilidad de lo que esa vela te esté diciendo una verdad.

Lo que quiero decir es que las velas y sus patrones nos *asistirán* (son un identificador más a nuestro arsenal) a verificar cuando deberíamos considerar entrar o salir de un activo.

Pero sin decirte exactamente cuando.

Si por ejemplo estás [siguiendo el método de Weinstein](https://pau.ninja/metodo-stan-weinstein/) (#582), ves una ruptura de etapa 1 entrando a etapa 2 que quieres coger, y una tipo de vela japonesa super alcista te lo confirma… ¿a caso no querrías saber que en efecto te lo confirma?
...
No es la vela que te indica si entrar o salir, sino tu sistema. Tu método, y la vela te da otro *ok* más.
...
- [Qué son las velas japonesas](#Que_son_las_velas_japonesas 'Qué son las velas japonesas')
- [Qué indican las velas japonesas](#Que_indican_las_velas_japonesas 'Qué indican las velas japonesas')
  - [Velas verdes (alcistas)](#Velas_verdes_alcistas 'Velas verdes (alcistas)')
  - [Velas rojas (bajistas)](#Velas_rojas_bajistas 'Velas rojas (bajistas)')
- [Partes de las velas japonesas](#Partes_de_las_velas_japonesas 'Partes de las velas japonesas')
  - [Mecha superior](#Mecha_superior 'Mecha superior')
  - [Mecha inferior](#Mecha_inferior 'Mecha inferior')
  - [Cuerpo](#Cuerpo 'Cuerpo')
- [Cómo interpretar las velas japonesas](#Como_interpretar_las_velas_japonesas 'Cómo interpretar las velas japonesas')
  - [Entender las velas japonesas](#Entender_las_velas_japonesas 'Entender las velas japonesas')
  - [Leer gráficos de velas](#Leer_graficos_de_velas 'Leer gráficos de velas')
- [Cómo estudiar las velas japonesas](#Como_estudiar_las_velas_japonesas 'Cómo estudiar las velas japonesas')
  - [Libros](#Libros 'Libros')
  - [Tarjetas de memorización](#Tarjetas_de_memorizacion 'Tarjetas de memorización')
  - [Usando indicadores](#Usando_indicadores 'Usando indicadores')
  - [Práctica deliberada](#Practica_deliberada 'Práctica deliberada')
...
![velas japonesas qué son](https://pau.ninja/wp-content/uploads/2024/03/velas-japonesas-que-son.png)
...
Y lo interesante de las velas japonesas, como ahora veremos, es que cuanto más grande sea la temporalidad, más *verdadera* será la información de la vela. Es decir, que más nos dice sobre lo que está haciendo la acción en cuanto a tendencia.
...
Aunque es verdad que en muchos libros y recursos de aprendizaje se representan en blanco y negro.

![tipos de velas japonesas](https://pau.ninja/wp-content/uploads/2024/03/tipos-de-velas-japonesas.png)
...
![vela verde](https://pau.ninja/wp-content/uploads/2024/03/vela-verde.png)
...
![vela roja](https://pau.ninja/wp-content/uploads/2024/03/vela-roja.png)
...
![partes de las velas japonesas](https://pau.ninja/wp-content/uploads/2024/03/partes-de-las-velas-japonesas.jpeg)
...
![mecha superior vela japonesa](https://pau.ninja/wp-content/uploads/2024/03/mecha-superior-vela-japonesa.png)
...
![mecha inferior vela japonesa](https://pau.ninja/wp-content/uploads/2024/03/mecha-inferior-vela-japonesa.png)

¿Qué indicará esto? Pues que, ese ha sido el precio más bajo de ese día.
...
![cuerpo vela japonesa](https://pau.ninja/wp-content/uploads/2024/03/cuerpo-vela-japonesa.png)
...
![cuerpo vela verde](https://pau.ninja/wp-content/uploads/2024/03/cuerpo-vela-verde.png)
...
![cuerpo vela roja](https://pau.ninja/wp-content/uploads/2024/03/cuerpo-vela-roja.png)
...
Es la mejor manera que hay para acordarse en vez de simplemente memorizarlo, aunque veremos maneras de [como retener mejor la información](https://pau.ninja/como-retener-mejor-la-informacion/) de las velas en un rato con algunos [recursos para aprender y memorizar las velas](#Como_estudiar_las_velas_japonesas).
...
![vela grande](https://pau.ninja/wp-content/uploads/2024/03/vela-grande.png)
...
![precio apertura vela](https://pau.ninja/wp-content/uploads/2024/03/precio-apertura-vela.png)
...
Es decir que los compradores, desde que inicio el mercado (y se generó el precio de apertura en la parte más baja de la vela), fueron capaces de *viajar* durante mucha distancia hacia arriba.

![vela verde grande](https://pau.ninja/wp-content/uploads/2024/03/vela-verde-grande.png)
...
![vela martillo invertida verde](https://pau.ninja/wp-content/uploads/2024/03/vela-martillo-invertida-verde.png)
...
![significado vela martillo](https://pau.ninja/wp-content/uploads/2024/03/significado-vela-martillo.png)

Lo sabemos porque hay *mecha* o *sombra*.
...
![significado martillo invertido](https://pau.ninja/wp-content/uploads/2024/03/significado-martillo-invertido.png)

Con esto podemos ver como, igual que la anterior vela gorda, aquí los compradores también eran más fuertes que los vendedores pero que su poder no era abrumador como antes.
...
![ejemplo mecha bajista](https://pau.ninja/wp-content/uploads/2024/03/ejemplo-mecha-bajista.png)
...
![ejemplos de mechas alcistas](https://pau.ninja/wp-content/uploads/2024/03/ejemplos-de-mechas-alcistas.png)
...
Porque algunas velas simplemente te servirán para identificar qué ha hecho el precio, pero hay unas pocas que tienen un porcentaje alto de posibilidades de que indiquen como el precio va a hacer una cosa u otra.
...
- También puedes [comprar tarjetas de memorización](https://pau.ninja/tienda/tarjetas-de-memorizacion/) en la tienda eligiendo el mazo correspondiente.
...
Irte a un gráfico en tu plataforma de análisis técnico ([esta es la que uso yo](https://pau.ninja/recursos/#Inversion)), poner el _modo retroceso_ en el tiempo, ir pasando gráficos e ir intentando de identificar qué es lo que te va apareciendo en pantalla.
...
Intentar *predecir* si el valor se irá hacia arriba o hacia abajo según ves que aparecen velas y si van en sintonía con los indicadores que utilizas.

Es como una pregunta tipo test que puedes responder al instante [gracias a la plataforma de inversión](https://pau.ninja/recursos/#Inversion) que tienen esta opción de hacer _backtesting_.
