---
title: "Impuesto de procrastinación"
url: https://pau.ninja/causas-de-la-procrastinacion
...
scrappedAt: 2024-11-02T15:23:15.961Z
...
bibliography: ["Ophir, E. Nass, C., & Wagner, A. (2009). Cognitive control in media multitaskers. Proceedings of the National Academy of Sciences, 106(37)","Wintour, P. (2009). Facebook and Bebo risk of ‘infantilising’ the human mind. Guardina. Retrieved from http://www.guardian.co.uk/uk/2009/feb/24/ social-networking-site-changing-childrens-brain","Wilson TD, Reinhard DA, Westgate EC, Gilbert DT, Ellerbeck N, Hahn C, Brown CL, Shaked A. Social psychology. Just think: the challenges of the disengaged mind. Science. 2014 Jul 4;345(6192):75-7. doi: 10.1126/science.1250830. PMID: 24994650; PMCID: PMC4330241.","Parkinson’s Law Publication: The Economist Publisher: The Economist Group Limited Date: Dec 31, 1969","Clarry H Lay, At last, my research article on procrastination, Journal of Research in Personality, Volume 20, Issue 4, 1986, Pages 474-495, ISSN 0092-6566.","Steel, Piers. (2007). The nature of procrastination: a meta-analytic and theoretical review of quintessential self-regulatory failure. Psychol Bull 133: 65-94. Psychological bulletin. 133. 65-94. 10.1037/0033-2909.133.1.65.","Asikhia, Olubusayo. (2010). Academic Procrastination in Mathematics: Causes, Dangers and Implications of Counselling for Effective Learning. International Education Studies. 3. 10.5539/ies.v3n3p205.","Rabin LA, Fogel J, Nutter-Upham KE. Academic procrastination in college students: the role of self-reported executive function. J Clin Exp Neuropsychol. 2011 Mar;33(3):344-57. doi: 10.1080/13803395.2010.518597. Epub 2010 Nov 25. PMID: 21113838.","Rabin, Laura & Fogel, Joshua & Eskine, Kate. (2010). Academic procrastination in college students: The role of self-reported executive function. Journal of clinical and experimental neuropsychology. 33. 344-57. 10.1080/13803395.2010.518597.","Deemer, Eric & Smith, Jessi & Carroll, Ashley & Carpenter, Jenna. (2014). Academic Procrastination in STEM: Interactive Effects of Stereotype Threat and Achievement Goals. The Career Development Quarterly. 62. 10.1002/j.2161-0045.2014.00076.x.","Mark, Gloria & Gudith, Daniela & Klocke, Ulrich. (2008). The cost of interrupted work: More speed and stress. Conference on Human Factors in Computing Systems – Proceedings. 107-110. 10.1145/1357054.1357072.","Rubinstein, J. S., Meyer, D. E. & Evans, J. E. (2001). Executive Control of Cognitive Processes in Task Switching. Journal of Experimental Psychology: Human Perception and Performance, 27, 763-797.","The Large-Display User Experience,” by George Robertson, Mary Czerwinski, et al, 2005, Microsoft Research","The Multiple Display Market and Consumer Attitudes,” Jon Peddie Research, June 1, 2009, jonpeddie.com","Productivity and Multi-Screen Computer Displays,” Colvin, Tobler & Anderson; Rocky Mountain Communication Review vol. 2:1, Summer 2004, pages 31-53","Examination of Dual vs. Single Monitor Use during Common Office Tasks,” by Justin. W. Owens, Jennifer Teves, et al; Proceedings of the Human Factors and Ergonomics Society Annual Meeting, September 2012, vol. 56, no. 1, 1506-1510","Mavelink (2019), «How Much Time is Your Company Losing Switching Between Applications?»","Hyman Ira E. Jr., S. Matthew Boss, Breanne M. Wise, Kira E. McKenzie, Jenna M. . “Did you see the unicycling clown? Inattentional blindness while walking and talking on a cell phone”. Applied Cognitive Psychology, December, 2009.","Leroy, Sophie, 2009. «Why is it so hard to do my work? The challenge of attention residue when switching between work tasks,» Organizational Behavior and Human Decision Processes, Elsevier, vol. 109(2), pages 168-181, July.","Mark, Gloria & Iqbal, Shamsi & Czerwinski, Mary & Johns, Paul. (2015). Focused, Aroused, but so Distractible. 903-916. 10.1145/2675133.2675221.","Mark, Gloria & Iqbal, Shamsi & Czerwinski, Mary & Johns, Paul. (2015). Focused, Aroused, but so Distractible. 903-916. 10.1145/2675133.2675221.","Miller, G. A. (1956). «The magical number seven, plus or minus two: Some limits on our capacity for processing information». Psychological Review. 63 (2): 81–97. CiteSeerX 10.1.1.308.8071. doi:10.1037/h0043158. hdl:11858/00-001M-0000-002C-4646-B. PMID 13310704.","Hyman Ira E. Jr., S. Matthew Boss, Breanne M. Wise, Kira E. McKenzie, Jenna M. . “Did you see the unicycling clown? Inattentional blindness while walking and talking on a cell phone”. Applied Cognitive Psychology, December, 2009.","Stothart C, Mitchum A, Yehnert C. The attentional cost of receiving a cell phone notification. J Exp Psychol Hum Percept Perform. 2015 Aug;41(4):893-897. doi: 10.1037/xhp0000100. Epub 2015 Jun 29. PMID: 26121498.","Ward, Adrian & Duke, Kristen & Gneezy, Ayelet & Bos, Maarten. (2017). Brain Drain: The Mere Presence of One’s Own Smartphone Reduces Available Cognitive Capacity. Journal of the Association for Consumer Research. 2. 000-000. 10.1086/691462.","Jackson, Thomas & Dawson, Ray & Wilson, Darren. (2003). Understanding email interaction increases organizational productivity. Communications of the ACM. 46. 10.1145/859670.859673.","Gloria Mark (2004), Work fragmentation as common practice: The paradox of IT support","Roetzel, P.G. Information overload in the information age: a review of the literature from business administration, business psychology, and related disciplines with a bibliometric approach and framework development. Bus Res 12, 479–522 (2019).","https://www.okta.com/sites/default/files/Okta\\_BW\\_2019v3.pdf","(2016). Information Overload: Causes, Consequences and Remedies – A Study. Philosophy and Progress. 55. 49. 10.3329/pp.v55i1-2.26390.","Gausby, A. (Spring 2015). Attention Spans (Download PDF). Microsoft Canada.","Pilieci, V. (May 12, 2015). Canadians now have shorter attention span than goldfish thanks to portable devices: Microsoft study. National Post.","Antoine Bechara and others, Emotion, Decision Making and the Orbitofrontal Cortex, Cerebral Cortex, Volume 10, Issue 3, March 2000, Pages 295–307."]
---
...
Por esto el contenido corto de las redes sociales, hecho para que sea altamente adictivo, nos ha robado literalmente segundos de memoria a corto plazo[ref-1](#ref-1){.ref}[ref-2](#ref-2){.ref}.

Buscamos ser productivos para poder [alcanzar el estado de _flow_](./estado-de-flow) (#486) y que nuestros proyectos vayan rodados, pero **nos perdemos en una procrastinación cada vez más abundante** y suculenta.
...
No me extraña después ver estudios en los que se verifica que casi el 70% de las personas preferirían recibir una pequeña descarga eléctrica antes que quedarse en una habitación a solas con sus propios pensamientos.[ref-3](#ref-3){.ref}
...
- **El estudiante:** es el tipo de procrastinador que lee muchos libros, escucha muchos podcast, ve muchos vídeos pero casi nunca lo aplica en su vida real. En vez de atacar por una vez por todas a lo más importante del día, se pone a consumir información. El estudiante procrastinador se siente bien porque está _aprendiendo_. El problema es que debería estar _haciendo_. El conocimiento es poder, pero sólo si lo aplicamos. Es como comprarte una espada de rango S pero ser aún nivel B. Necesitas entrenar la habilidad para empuñarla.
...
No lo digo yo, lo dicen décadas de investigación psicológica que finalmente han concluido que…[ref-5](#ref-5){.ref}[ref-6](#ref-6){.ref}

> La procrastinación es un problema funcional y emocional, no una consecuencia de ser vago.[ref-7](#ref-7){.ref}
...
Fijaros en esto: ansiedad[ref-8](#ref-8){.ref} y falta de claridad[ref-9](#ref-9){.ref} , no pereza.

De hecho los estudios han visto como es más probable que procrastinemos cuando la tarea es importante y transcendente para nosotros como individuos. Cuando nos involucramos, importándonos lo suficiente para que salga bien.[ref-10](#ref-10){.ref} .
...
![cambios de contexto en la productividad](./wp-content/uploads/2023/06cambios-de-contexto-en-la-productividad.jpeg)
...
De hecho le toma a nuestra mente una media de 23 minutos y 15 segundos antes de volver a estar enfocada en la tarea en la que estaba hace un momento, «robando» un 40% del tiempo productivo total de esa persona.[ref-11](#ref-11){.ref} [ref-12](#ref-12){.ref}
...
Porqué hay estudios que aseguran que en ciertas situaciones se incrementa la productividad.[ref-13](#ref-13){.ref}[ref-14](#ref-14){.ref}[ref-15](#ref-15){.ref}[ref-16](#ref-16){.ref} Pero en otros estudios se ve como +70% de usuarios terminan abriendo más aplicaciones y cambiando de contexto aún más a menudo.[ref-17](#ref-17){.ref}
...
Por esto hablamos de que has pagado un «impuesto de productividad», porque se ha visto como ir cambiando de contexto nos puede bajar la productividad en un 40%.[ref-18](#ref-18){.ref}

Causado (como no) por los cambios de contexto.

Los que experimentan residuo de atención después de cambiar de tareas les baja el rendimiento en la siguiente tareas que van a hacer.[ref-19](#ref-19){.ref}[ref-20](#ref-20){.ref}

A más atención dividida, más difícil se hace concentrarse.

Si alcanzar la zona mental de _trabajo profundo_, [uno de los estados de _flow_](./estado-de-flow) (#483), es precisamente un estado de consciencia al que sólo entramos después de haber dirigido la atención en algo que nos hace luchar un poco, y se genera una bola de nieve para poder entrar en esa _zona_, entonces…

![fases para alcanzar el estado de flow](./wp-content/uploads/2023/05fases-para-alcanzar-estado-de-flow.jpeg)

Si vamos cambiando de contexto y arrastrando residuo de atención, a efectos prácticos estamos haciendo lo opuesto a entrar en _flow_.

Nos estamos alejando cada vez más.[ref-21](#ref-21){.ref}

Lo que más me h0de es que lo terminamos haciendo sin darnos cuenta.

### Queremos hacer muchas cosas al mismo tiempo

Y es que sólo podemos retener de 3 a 7 trozos de información al mismo momento.[ref-22](#ref-22){.ref} Como un malabarista al que si le pones algunas pelotas más se van todas al suelo.
...
Recordemos que estas empresas gigantes no sólo tiene _supernecios_ trabajando para programar apps con buena usabilidad para el usuario… sino también **equipos de psicólogos para hacer que sean lo más adictivas posibles**.
...
Mirad si lo han hecho bien esos _supernecios_ que estudios han visto sólo como por el hecho de **tener el móvil a la vista el cerebro se siente atraído** hacia él.[ref-25](#ref-25){.ref}
...
Y que **más del 70% responde en menos de 6 segundos** cuando recibe un mensaje nuevo.[ref-26](#ref-26){.ref}

![distracciones que impiden concentrarse](./wp-content/uploads/2023/06distracciones-que-impiden-concentrarse.jpeg)

Si incluso antes de la era de las aplicaciones como tenemos ahora, ya había estudios que indicaban que el trabajador medio tenia una **media de 3 minutos de foco** antes de cambiar de contexto.[ref-27](#ref-27){.ref}
...
Necesitaríamos 3 vidas eternas para consumir toda información a la que estamos expuestos ahora, pero fijaros que el fraile dominico Vicente de Beauvais ya decía en el 1255:[ref-28](#ref-28){.ref}
...
Pero esto para nosotros es calderilla ninjas de la vida. Si actualmente los directivos de 2010 ya estaban recibiendo 30.000 notificaciones al año. Lo equivalente a **una comunicación cada 4 minutos**.[ref-29](#ref-29){.ref}[ref-30](#ref-30){.ref}
...
Normal que un estudio de Microsoft enseñara como hemos pasado de 12 segundos a 8 segundos de capacidad de atención.[ref-31](#ref-31){.ref}[ref-32](#ref-32){.ref}

A nivel porcentual es muy preocupante.

## Un tratamiento para la procrastinación

Las decisiones que tomamos están basadas en emociones.[ref-33](#ref-33){.ref} Es nuestra corteza prefrontal la encargada de tomarlas. La parte pensante más rápida de nuestra cabeza. El llamado Sistema 1.
