---
title: "Bitcoin protegido de torturas, robos y extorsiones ¿Dónde guardar Bitcoin de forma segura?"
...
[https://www.ivoox.com/\_md_84907091_wp_1.mp3](https://www.ivoox.com/_md_84907091_wp_1.mp3)
...
- [Qué son las claves privadas de Bitcoin](#Que_son_las_claves_privadas_de_Bitcoin 'Qué son las claves privadas de Bitcoin')
- [Cómo guardar bitcoin de forma segura](#Como_guardar_bitcoin_de_forma_segura 'Cómo guardar bitcoin de forma segura')
  - [Guardar bitcoin en un pendrive](#Guardar_bitcoin_en_un_pendrive 'Guardar bitcoin en un pendrive')
  - [Nunca escribir online las claves privadas](#Nunca_escribir_online_las_claves_privadas 'Nunca escribir online las claves privadas')
  - [Asentar el nivel de seguridad](#Asentar_el_nivel_de_seguridad 'Asentar el nivel de seguridad')
  - [Elegir el formato de respaldo](#Elegir_el_formato_de_respaldo 'Elegir el formato de respaldo')
  - [Considerar una passphrase](#Considerar_una_passphrase 'Considerar una passphrase')
- [Dónde guardar criptomonedas de forma segura](#Donde_guardar_criptomonedas_de_forma_segura 'Dónde guardar criptomonedas de forma segura')
  - [En papel](#En_papel 'En papel')
  - [Cryptosteel](#Cryptosteel 'Cryptosteel')
  - [Con intermediarios](#Con_intermediarios 'Con intermediarios')
- [Ideas creativas donde guardar claves privadas](#Ideas_creativas_donde_guardar_claves_privadas 'Ideas creativas donde guardar claves privadas')
  - [Lista de libros](#Lista_de_libros 'Lista de libros')
  - [Escribir un poema](#Escribir_un_poema 'Escribir un poema')
  - [Con una serie de tweets](#Con_una_serie_de_tweets 'Con una serie de tweets')
  - [Con cuentas de Instagram](#Con_cuentas_de_Instagram 'Con cuentas de Instagram')
  - [Crear memes](#Crear_memes 'Crear memes')
  - [Con un servidor de Discord](#Con_un_servidor_de_Discord 'Con un servidor de Discord')
- [Dónde no guardar](#Donde_no_guardar 'Dónde no guardar')

## Qué son las claves privadas de Bitcoin

Siempre, siempre y siempre, cuando te [creas una _wallet_/monedero Bitcoin](https://pau.ninja/bitcoin-wallet/), en los primeros pasos hay un paso que te dice «guárdate estas claves en un papel para recuperarlas». Y te aparecen ahí una lista de 12 a 24 palabras aleatorias del diccionario inglés.

![claves privadas ejemplo](https://pau.ninja/wp-content/uploads/2022/03/claves-privadas-ejemplo.jpeg)
...
Lo primero sería hacernos crear una [cold wallet](https://pau.ninja/bitcoin-wallet/) (monedero frío) para guardar bitcoin de forma segura. Son los típicos _pendrives_, pero ojo, que no es que tus bitcoin estén allí dentro. No.
...
[![Arregui C9362 - Contenedor secreto bote spray acero surtido **](https://pau.ninja/wp-content/plugins/aawp/public/image.php?url=YUhSMGNITTZMeTl0TG0xbFpHbGhMV0Z0WVhwdmJpNWpiMjB2YVcxaFoyVnpMMGt2TXpGNVZYRmFiM1pwYmt3dVgxTk1NVFl3WHk1cWNHYz18MTcyODg5NjQ1Mw=)](https://www.amazon.es/dp/B00HH7IJJ8?tag=pau-ninja-21&linkCode=ogi&th=1&psc=1&keywords=lata%20falsa%20escondite 'Arregui C9362 - Contenedor secreto bote spray acero surtido **')
...
Antes de ver posibles sitios físicos donde guardar las 24 clave, para que lo tengáis en cuenta, exista una opción avanzada de seguridad. Se trata de añadir una palabra extra, una _passphrase_ a la lista de nuestras palabras de recuperación. La *passphrase* es la palabra número 25.
...
![ejemplo passphrase](https://pau.ninja/wp-content/uploads/2022/03/ejemplo-passphrase.jpeg)
...
Una opción sería ir a Aliexpress a comprar un neceser o [bolsa anti inflamable](https://s.click.aliexpress.com/e/_97F4yx). De esas con cremalleras que por menos de 10€ pones tus cosas de valor allí dentro. Para que las proteja si se incendia la casa. Pero claro, aunque acabemos de solucionar el fuego, no solucionamos el potencial robo, o el desgaste con el paso del tiempo que tiene el papel.

![claves bitcoin ledger](https://pau.ninja/wp-content/uploads/2022/03/claves-bitcoin-ledger.jpeg)
...
![cryptosteel](https://pau.ninja/wp-content/uploads/2022/03/cryptosteel.jpeg)
...
Yo había usado la red social [Goodreads](https://www.goodreads.com/) para guardar listas de libros de lo que había leído o quería leer.
...
![ejemplo lista libros](https://pau.ninja/wp-content/uploads/2022/03/ejemplo-lista-libros.jpeg)
...
![ejemplo poemas](https://pau.ninja/wp-content/uploads/2022/03/ejemplo-poemas.jpeg)
...
![ejemplo tweets](https://pau.ninja/wp-content/uploads/2022/03/ejemplo-tweets.png)
...
![ejemplo memes](https://pau.ninja/wp-content/uploads/2022/03/ejemplo-memes.jpg)
...
![ejemplo palabras discord](https://pau.ninja/wp-content/uploads/2022/03/ejemplo-palabras-discord.jpeg)
